...
static mut transformoption: jpeg_transform_info = jpeg_transform_info {
    ...
    num_components: 0,
    workspace_coef_arrays: 0 as *const jvirt_barray_ptr as *mut jvirt_barray_ptr,
    output_width: 0,
    output_height: 0,
    x_crop_offset: 0,
    y_crop_offset: 0,
 ...
 */
{
    if transformoption.transform as c_uint == JXFORM_NONE as c_int as c_uint
        || transformoption.transform as c_uint == transform as c_uint
    {
 ...
 * processing.
 */ {
    let mut argn: c_int = 0; /* saves -scans parm if any */
    ...
    while argn < argc {
        ...
        /* else done parsing switches */
            ...
            if keymatch(arg, b"arithmetic\x00" as *const u8 as *const c_char, 1i32) != 0 {
                ...
                if keymatch(arg, b"copy\x00" as *const u8 as *const c_char, 2i32) != 0 {
                    ...
                    ) != 0
                    {
                        ...
                        *argv.offset(argn as isize),
                        b"comments\x00" as *const u8 as *const c_char,
                        1i32,
                    ) != 0
                    {
                        ...
                        *argv.offset(argn as isize),
                        b"all\x00" as *const u8 as *const c_char,
                        1i32,
                    ) != 0
                    {
                    ...
                    if jtransform_parse_crop_spec(&mut transformoption, *argv.offset(argn as isize))
                        == 0
                    {
                        fprintf(
                            stderr,
                    ...
                    || keymatch(arg, b"verbose\x00" as *const u8 as *const c_char, 1i32) != 0
                {
                    ...
                    if keymatch(arg, b"flip\x00" as *const u8 as *const c_char, 1i32) != 0 {
                        ...
                        if keymatch(
                            *argv.offset(argn as isize),
                            b"horizontal\x00" as *const u8 as *const c_char,
                            1i32,
                        ) != 0
                        {
                            ...
                            *argv.offset(argn as isize),
                            b"vertical\x00" as *const u8 as *const c_char,
                            1i32,
                        ) != 0
                        {
                        ...
                        prefer_smallest = FALSE
                    } else if keymatch(arg, b"fastcrush\x00" as *const u8 as *const c_char, 4i32)
                        != 0
                    {
                        jpeg_c_set_bool_param(cinfo, JBOOLEAN_OPTIMIZE_SCANS, FALSE);
                    } else if keymatch(arg, b"grayscale\x00" as *const u8 as *const c_char, 1i32)
                        != 0
                        || keymatch(arg, b"greyscale\x00" as *const u8 as *const c_char, 1i32) != 0
                    {
                        /* Force to grayscale. */
                    ...
                    } else if keymatch(arg, b"perfect\x00" as *const u8 as *const c_char, 2i32) != 0
                    {
                        /* Fail if there is any partial edge MCUs that the transform can't
                         * handle. */
                        transformoption.perfect = TRUE
                    } else if keymatch(arg, b"progressive\x00" as *const u8 as *const c_char, 2i32)
                        != 0
                    {
                    ...
                    } else if keymatch(arg, b"revert\x00" as *const u8 as *const c_char, 3i32) != 0
                    {
                        ...
                        prefer_smallest = FALSE
                    } else if keymatch(arg, b"rotate\x00" as *const u8 as *const c_char, 2i32) != 0
                    {
                        ...
                        if keymatch(
                            *argv.offset(argn as isize),
                            b"90\x00" as *const u8 as *const c_char,
                            2i32,
                        ) != 0
                        {
                            ...
                            *argv.offset(argn as isize),
                            b"180\x00" as *const u8 as *const c_char,
                            3i32,
                        ) != 0
                        {
                            ...
                            *argv.offset(argn as isize),
                            b"270\x00" as *const u8 as *const c_char,
                            3i32,
                        ) != 0
                        {
                        ...
                        prefer_smallest = FALSE
                    } else if keymatch(arg, b"scans\x00" as *const u8 as *const c_char, 1i32) != 0 {
                        /* Set scan script. */
                        argn += 1;
                        if argn >= argc {
                            /* advance to next argument */
                    ...
                    } else if keymatch(arg, b"transpose\x00" as *const u8 as *const c_char, 1i32)
                        != 0
                    {
                        /* Transpose (across UL-to-LR axis). */
                        select_transform(JXFORM_TRANSPOSE);
                        prefer_smallest = FALSE
                    } else if keymatch(arg, b"transverse\x00" as *const u8 as *const c_char, 6i32)
                        != 0
                    {
                        /* Transverse transpose (across UR-to-LL axis). */
                        select_transform(JXFORM_TRANSVERSE);
                        prefer_smallest = FALSE
                    } else if keymatch(arg, b"trim\x00" as *const u8 as *const c_char, 3i32) != 0 {
...
unsafe fn main_0(mut argc: c_int, mut argv: *mut *mut c_char) -> c_int {
    ...
    let mut src_coef_arrays: *mut jvirt_barray_ptr = 0 as *mut jvirt_barray_ptr;
    let mut dst_coef_arrays: *mut jvirt_barray_ptr = 0 as *mut jvirt_barray_ptr;
    ...
    let mut icc_profile: *mut JOCTET = NULL as *mut JOCTET;
    ...
    if progname.is_null() || *progname.offset(0) as c_int == 0i32 {
        progname = b"jpegtran\x00" as *const u8 as *const c_char
    }
     ...
     */
    file_index = parse_switches(&mut dstinfo, argc, argv, 0i32, FALSE);
    ...
    /* Open the input file. */
    if file_index < argc {
        fp = fopen(*argv.offset(file_index as isize), READ_BINARY.as_ptr());
        if fp.is_null() {
            fprintf(
                stderr,
    ...
    if !icc_filename.is_null() {
        ...
        fclose(icc_file);
        if copyoption as c_uint == JCOPYOPT_ALL as c_int as c_uint {
            copyoption = JCOPYOPT_ALL_EXCEPT_ICC
        }
    }
    /* Specify data source for decompression */
    if jpeg_c_int_param_supported(&mut dstinfo, JINT_COMPRESS_PROFILE) != 0
        && jpeg_c_get_int_param(&mut dstinfo, JINT_COMPRESS_PROFILE) == JCP_MAX_COMPRESSION as c_int
    {
        memsrc = TRUE
    ...
    if !icc_profile.is_null() {
        jpeg_write_icc_profile(&mut dstinfo, icc_profile, icc_len as c_uint);
    }
        ...
        && jpeg_c_get_int_param(&mut dstinfo, JINT_COMPRESS_PROFILE) == JCP_MAX_COMPRESSION as c_int
    {
        ...
        nbytes_0 = fwrite(buffer as *const c_void, 1i32 as size_t, size, fp);
