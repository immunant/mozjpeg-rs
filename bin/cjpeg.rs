...
use libc::{c_char, c_float, c_int, c_long, c_uchar, c_uint, c_ulong, c_void};
use mozjpeg::*;
use std::prelude::v1;
use std::prelude::v1::*;
/*
...
static mut cdjpeg_message_table: [*const c_char; 47] = [
    ...
    b"GIF output got confused\x00" as *const u8 as *const c_char,
    b"Bogus GIF codesize %d\x00" as *const u8 as *const c_char,
    b"GIF output must be grayscale or RGB\x00" as *const u8 as *const c_char,
    b"Too few images in GIF file\x00" as *const u8 as *const c_char,
    b"Not a GIF file\x00" as *const u8 as *const c_char,
    b"%ux%ux%d GIF image\x00" as *const u8 as *const c_char,
    b"Warning: unexpected GIF version number \'%c%c%c\'\x00" as *const u8 as *const c_char,
    b"Ignoring GIF extension block of type 0x%02x\x00" as *const u8 as *const c_char,
    b"Caution: nonsquare pixels in input\x00" as *const u8 as *const c_char,
    b"Corrupt data in GIF file\x00" as *const u8 as *const c_char,
    b"Bogus char 0x%02x in GIF file, ignoring\x00" as *const u8 as *const c_char,
    b"Premature end of GIF image\x00" as *const u8 as *const c_char,
    b"Ran out of GIF bits\x00" as *const u8 as *const c_char,
    ...
    b"Unsupported Targa colormap format\x00" as *const u8 as *const c_char,
    b"Invalid or unsupported Targa file\x00" as *const u8 as *const c_char,
    b"Targa output must be grayscale or RGB\x00" as *const u8 as *const c_char,
    b"%ux%u RGB Targa image\x00" as *const u8 as *const c_char,
    b"%ux%u grayscale Targa image\x00" as *const u8 as *const c_char,
    b"%ux%u colormapped Targa image\x00" as *const u8 as *const c_char,
...
static mut icc_filename: *mut c_char = 0 as *const c_char as *mut c_char;
/* for -icc switch */

static mut outfilename: *mut c_char = 0 as *const c_char as *mut c_char;
/* for -outfile switch */
#[no_mangle]
...
/* complain about bad command line */
{
    ...
    fprintf(
        ...
        if JDCT_DEFAULT == JDCT_ISLOW as c_int {
            b" (default)\x00" as *const u8 as *const c_char
        } else {
 ...
 * processing.
 */ {
    let mut argn: c_int = 0; /* saves -quality parm if any */
    let mut arg: *mut c_char = 0 as *mut c_char; /* saves -qtables filename if any */
    let mut force_baseline: boolean = 0; /* saves -qslots parm if any */
    let mut simple_progressive: boolean = 0; /* saves -sample parm if any */
    ...
    while argn < argc {
        ...
        /* else done parsing switches */
            ...
            if keymatch(arg, b"arithmetic\x00" as *const u8 as *const c_char, 1i32) != 0 {
                ...
                if keymatch(arg, b"baseline\x00" as *const u8 as *const c_char, 1i32) != 0 {
                    /* Force baseline-compatible output (8-bit quantizer values). */
                    force_baseline = TRUE;
                    /* Disable multiple scans */
                    simple_progressive = FALSE;
                    (*cinfo).num_scans = 0i32;
                    (*cinfo).scan_info = NULL_0 as *const jpeg_scan_info
                } else if keymatch(arg, b"dct\x00" as *const u8 as *const c_char, 2i32) != 0 {
                    ...
                    if keymatch(
                        *argv.offset(argn as isize),
                        b"int\x00" as *const u8 as *const c_char,
                        1i32,
                    ) != 0
                    {
                        ...
                        *argv.offset(argn as isize),
                        b"fast\x00" as *const u8 as *const c_char,
                        2i32,
                    ) != 0
                    {
                        ...
                        *argv.offset(argn as isize),
                        b"float\x00" as *const u8 as *const c_char,
                        2i32,
                    ) != 0
                    {
                ...
                } else if keymatch(arg, b"debug\x00" as *const u8 as *const c_char, 1i32) != 0
                    || keymatch(arg, b"verbose\x00" as *const u8 as *const c_char, 1i32) != 0
                {
                ...
                } else if keymatch(arg, b"version\x00" as *const u8 as *const c_char, 4i32) != 0 {
                    fprintf(
                        stderr,
                        b"%s version %s (build %s)\n\x00" as *const u8 as *const c_char,
                        PACKAGE_NAME.as_ptr(),
                    ...
                    if keymatch(arg, b"fastcrush\x00" as *const u8 as *const c_char, 4i32) != 0 {
                        jpeg_c_set_bool_param(cinfo, JBOOLEAN_OPTIMIZE_SCANS, FALSE);
                    } else if keymatch(arg, b"grayscale\x00" as *const u8 as *const c_char, 2i32)
                        != 0
                        || keymatch(arg, b"greyscale\x00" as *const u8 as *const c_char, 2i32) != 0
                    {
                        /* Force a monochrome JPEG file to be generated. */
                        jpeg_set_colorspace(cinfo, JCS_GRAYSCALE);
                    } else if keymatch(arg, b"rgb\x00" as *const u8 as *const c_char, 3i32) != 0 {
                        /* Force an RGB JPEG file to be generated. */
                        jpeg_set_colorspace(cinfo, JCS_RGB);
                    } else if keymatch(arg, b"lambda1\x00" as *const u8 as *const c_char, 7i32) != 0
                    {
                        argn += 1;
                        if argn >= argc {
                            /* advance to next argument */
                    ...
                    } else if keymatch(arg, b"lambda2\x00" as *const u8 as *const c_char, 7i32) != 0
                    {
                        argn += 1;
                        if argn >= argc {
                            /* advance to next argument */
                    ...
                    } else if keymatch(arg, b"icc\x00" as *const u8 as *const c_char, 1i32) != 0 {
                        /* Set ICC filename. */
                        argn += 1;
                        if argn >= argc {
                            /* advance to next argument */
                    ...
                    } else if keymatch(arg, b"maxmemory\x00" as *const u8 as *const c_char, 3i32)
                        != 0
                    {
                    ...
                    } else if keymatch(arg, b"dc-scan-opt\x00" as *const u8 as *const c_char, 3i32)
                        != 0
                    {
                        argn += 1;
                        if argn >= argc {
                    ...
                    } else if keymatch(arg, b"optimize\x00" as *const u8 as *const c_char, 1i32)
                        != 0
                        || keymatch(arg, b"optimise\x00" as *const u8 as *const c_char, 1i32) != 0
                    {
                        /* Enable entropy parm optimization. */
                        (*cinfo).optimize_coding = TRUE
                    } else if keymatch(arg, b"outfile\x00" as *const u8 as *const c_char, 4i32) != 0
                    {
                    ...
                    } else if keymatch(arg, b"progressive\x00" as *const u8 as *const c_char, 1i32)
                        != 0
                    {
                        /* Select simple progressive mode. */
                        simple_progressive = TRUE
                    /* We must postpone execution until num_components is known. */
                    } else if keymatch(arg, b"memdst\x00" as *const u8 as *const c_char, 2i32) != 0
                    {
                        /* Use in-memory destination manager */
                        memdst = TRUE
                    } else if keymatch(arg, b"quality\x00" as *const u8 as *const c_char, 1i32) != 0
                    {
                    ...
                    } else if keymatch(arg, b"qslots\x00" as *const u8 as *const c_char, 2i32) != 0
                    {
                     ...
                     */
                    } else if keymatch(arg, b"qtables\x00" as *const u8 as *const c_char, 2i32) != 0
                    {
                    ...
                    } else if keymatch(arg, b"quant-table\x00" as *const u8 as *const c_char, 7i32)
                        != 0
                    {
                        let mut val: c_int = 0;
                        argn += 1;
                        ...
                        arg,
                        b"quant-baseline\x00" as *const u8 as *const c_char,
                        7i32,
                    ) != 0
                    {
                        /* Force quantization table to meet baseline requirements */
                        force_baseline = TRUE
                    } else if keymatch(arg, b"restart\x00" as *const u8 as *const c_char, 1i32) != 0
                    {
                        /* Restart interval in MCU rows (or in MCUs with 'b'). */
                        let mut lval_0: c_long = 0;
                        let mut ch_0: c_char = 'x' as i32 as c_char;
                        argn += 1;
                        if argn >= argc {
                            /* advance to next argument */
                            usage();
                        ...
                        if lval_0 < 0i32 as c_long || lval_0 > 65535i64 {
                            usage();
                        }
                    ...
                    } else if keymatch(arg, b"revert\x00" as *const u8 as *const c_char, 3i32) != 0
                    {
                        /* revert to old JPEG default */
                        jpeg_c_set_int_param(cinfo, JINT_COMPRESS_PROFILE, JCP_FASTEST as c_int);
                        jpeg_set_defaults(cinfo);
                    } else if keymatch(arg, b"sample\x00" as *const u8 as *const c_char, 2i32) != 0
                    {
                     ...
                     */
                    } else if keymatch(arg, b"scans\x00" as *const u8 as *const c_char, 4i32) != 0 {
                        /* Set scan script. */
                        argn += 1;
                        if argn >= argc {
                            /* advance to next argument */
                    ...
                    } else if keymatch(arg, b"smooth\x00" as *const u8 as *const c_char, 2i32) != 0
                    {
                    ...
                    } else if keymatch(arg, b"targa\x00" as *const u8 as *const c_char, 1i32) != 0 {
                        /* Input file is Targa format. */
                        is_targa = TRUE
                    } else if keymatch(
                        arg,
                        b"notrellis-dc\x00" as *const u8 as *const c_char,
                        11i32,
                    ) != 0
                    {
                        /* disable trellis quantization */
                        jpeg_c_set_bool_param(cinfo, JBOOLEAN_TRELLIS_QUANT_DC, FALSE);
                    } else if keymatch(arg, b"notrellis\x00" as *const u8 as *const c_char, 1i32)
                        != 0
                    {
                        /* disable trellis quantization */
                        ...
                        arg,
                        b"trellis-dc-ver-weight\x00" as *const u8 as *const c_char,
                        12i32,
                    ) != 0
                    {
                        argn += 1;
                    ...
                    } else if keymatch(arg, b"trellis-dc\x00" as *const u8 as *const c_char, 9i32)
                        != 0
                    {
                        /* enable DC trellis quantization */
                        jpeg_c_set_bool_param(cinfo, JBOOLEAN_TRELLIS_QUANT_DC, TRUE);
                    } else if keymatch(arg, b"tune-psnr\x00" as *const u8 as *const c_char, 6i32)
                        != 0
                    {
                        jpeg_c_set_int_param(cinfo, JINT_BASE_QUANT_TBL_IDX, 1i32);
                        jpeg_c_set_float_param(cinfo, JFLOAT_LAMBDA_LOG_SCALE1, 9.0f64 as c_float);
                        jpeg_c_set_float_param(cinfo, JFLOAT_LAMBDA_LOG_SCALE2, 0.0f64 as c_float);
                        jpeg_c_set_bool_param(cinfo, JBOOLEAN_USE_LAMBDA_WEIGHT_TBL, FALSE);
                        jpeg_set_quality(cinfo, 75i32, TRUE);
                    } else if keymatch(arg, b"tune-ssim\x00" as *const u8 as *const c_char, 6i32)
                        != 0
                    {
                        jpeg_c_set_int_param(cinfo, JINT_BASE_QUANT_TBL_IDX, 1i32);
                        jpeg_c_set_float_param(cinfo, JFLOAT_LAMBDA_LOG_SCALE1, 11.5f64 as c_float);
                        jpeg_c_set_float_param(
                            cinfo,
                            JFLOAT_LAMBDA_LOG_SCALE2,
                            12.75f64 as c_float,
                        ...
                        jpeg_c_set_bool_param(cinfo, JBOOLEAN_USE_LAMBDA_WEIGHT_TBL, FALSE);
                        jpeg_set_quality(cinfo, 75i32, TRUE);
                    } else if keymatch(arg, b"tune-ms-ssim\x00" as *const u8 as *const c_char, 6i32)
                        != 0
                    {
                        jpeg_c_set_int_param(cinfo, JINT_BASE_QUANT_TBL_IDX, 3i32);
                        jpeg_c_set_float_param(cinfo, JFLOAT_LAMBDA_LOG_SCALE1, 12.0f64 as c_float);
                        jpeg_c_set_float_param(cinfo, JFLOAT_LAMBDA_LOG_SCALE2, 13.0f64 as c_float);
                        jpeg_c_set_bool_param(cinfo, JBOOLEAN_USE_LAMBDA_WEIGHT_TBL, TRUE);
                        jpeg_set_quality(cinfo, 75i32, TRUE);
                    } else if keymatch(
                        arg,
                        b"tune-hvs-psnr\x00" as *const u8 as *const c_char,
                        6i32,
                    ) != 0
                    {
                        jpeg_c_set_int_param(cinfo, JINT_BASE_QUANT_TBL_IDX, 3i32);
                        ...
                        jpeg_c_set_float_param(cinfo, JFLOAT_LAMBDA_LOG_SCALE2, 16.5f64 as c_float);
                        jpeg_c_set_bool_param(cinfo, JBOOLEAN_USE_LAMBDA_WEIGHT_TBL, TRUE);
                        jpeg_set_quality(cinfo, 75i32, TRUE);
                    } else if keymatch(arg, b"noovershoot\x00" as *const u8 as *const c_char, 11i32)
                        != 0
                    {
                        jpeg_c_set_bool_param(cinfo, JBOOLEAN_OVERSHOOT_DERINGING, FALSE);
                    } else if keymatch(arg, b"nojfif\x00" as *const u8 as *const c_char, 6i32) != 0
                    {
...
unsafe fn main_0(mut argc: c_int, mut argv: *mut *mut c_char) -> c_int {
    ...
    let mut jerr: jpeg_error_mgr = jpeg_error_mgr {
        ...
        trace_level: 0,
        num_warnings: 0,
        jpeg_message_table: 0 as *const *const c_char,
        last_jpeg_message: 0,
        addon_message_table: 0 as *const *const c_char,
        first_addon_message: 0,
        last_addon_message: 0,
    };
    let mut file_index: c_int = 0;
    let mut src_mgr: cjpeg_source_ptr = 0 as *mut cjpeg_source_struct;
    let mut input_file: *mut FILE = 0 as *mut FILE;
    let mut icc_file: *mut FILE = 0 as *mut FILE;
    let mut icc_profile: *mut JOCTET = NULL_0 as *mut JOCTET;
    let mut icc_len: c_long = 0i32 as c_long;
    let mut output_file: *mut FILE = NULL_0 as *mut FILE;
    let mut outbuffer: *mut c_uchar = NULL_0 as *mut c_uchar;
    let mut outsize: c_ulong = 0i32 as c_ulong;
    ...
    if progname.is_null() || *progname.offset(0) as c_int == 0i32 {
        progname = b"cjpeg\x00" as *const u8 as *const c_char
    }
     ...
     * the input file.
     */
    file_index = parse_switches(&mut cinfo, argc, argv, 0i32, FALSE);
    ...
    /* Open the input file. */
    if file_index < argc {
        input_file = fopen(*argv.offset(file_index as isize), READ_BINARY.as_ptr());
    ...
    if !icc_filename.is_null() {
        icc_file = fopen(icc_filename, READ_BINARY.as_ptr());
        if icc_file.is_null() {
            fprintf(
                stderr,
                b"%s: can\'t open %s\n\x00" as *const u8 as *const c_char,
        ...
        if fseek(icc_file, 0i32 as c_long, SEEK_END) < 0i32
            || {
                icc_len = ftell(icc_file);
                (icc_len) < 1i32 as c_long
            }
            || fseek(icc_file, 0i32 as c_long, SEEK_SET) < 0i32
        {
            fprintf(
                stderr,
        ...
        icc_profile = malloc(icc_len as c_ulong) as *mut JOCTET;
