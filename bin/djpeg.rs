...
use libc::c_void;use libc::c_uchar;use libc::c_ulong;use libc::c_ushort;use std::prelude::v1;use libc::c_long;use libc::c_char;use libc::c_uint;use libc::c_int;use mozjpeg::*;
