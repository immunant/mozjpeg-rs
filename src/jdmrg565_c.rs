...
pub unsafe extern "C" fn h2v1_merged_upsample_565_be(
    ...
    while col > 0u32 {
        ...
        rgb = (r & 0xf8u32 | g >> 5i32 | g << 11i32 & 0xe000u32 | b << 5i32 & 0x1f00u32) as JLONG;
        let fresh73 = inptr0;
        inptr0 = inptr0.offset(1);
        y = *fresh73 as c_int;
        r = *range_limit.offset((y + cred) as isize) as c_uint;
        ...
        b = *range_limit.offset((y + cblue) as isize) as c_uint;
        rgb = rgb << 16i32
            | (r & 0xf8u32 | g >> 5i32 | g << 11i32 & 0xe000u32 | b << 5i32 & 0x1f00u32) as c_long;
        *(outptr as *mut INT16).offset(1) = rgb as INT16;
        *(outptr as *mut INT16).offset(0) = (rgb >> 16i32) as INT16;
...
pub unsafe extern "C" fn h2v1_merged_upsample_565_le(
    ...
    while col > 0u32 {
        ...
        g = *range_limit.offset((y + cgreen) as isize) as c_uint;
        b = *range_limit.offset((y + cblue) as isize) as c_uint;
        rgb = ((r << 8i32 & 0xf800u32 | g << 3i32 & 0x7e0u32 | b >> 3i32) << 16i32) as c_long | rgb;
        *(outptr as *mut INT16).offset(0) = rgb as INT16;
        *(outptr as *mut INT16).offset(1) = (rgb >> 16i32) as INT16;
        outptr = outptr.offset(4);
        col -= 1
    }
    if (*cinfo).output_width & 1u32 != 0 {
...
pub unsafe extern "C" fn h2v1_merged_upsample_565D_le(
    ...
    while col > 0u32 {
        ...
        inptr0 = inptr0.offset(1);
        y = *fresh80 as c_int;
        r = *range_limit.offset(((y + cred) as c_long + (d0 & 0xffi64)) as isize) as c_uint;
        g = *range_limit.offset(((y + cgreen) as c_long + ((d0 & 0xffi64) >> 1i32)) as isize)
            as c_uint;
        b = *range_limit.offset(((y + cblue) as c_long + (d0 & 0xffi64)) as isize) as c_uint;
...
pub unsafe extern "C" fn h2v2_merged_upsample_565_le(
    ...
    while col > 0u32 {
        ...
        *(outptr0 as *mut INT16).offset(1) = (rgb >> 16i32) as INT16;
        ...
        *(outptr1 as *mut INT16).offset(1) = (rgb >> 16i32) as INT16;
...
pub unsafe extern "C" fn h2v2_merged_upsample_565_be(
    ...
    while col > 0u32 {
        ...
        *(outptr0 as *mut INT16).offset(0) = (rgb >> 16i32) as INT16;
        outptr0 = outptr0.offset(4);
        let fresh96 = inptr01;
        inptr01 = inptr01.offset(1);
        y = *fresh96 as c_int;
        ...
        *(outptr1 as *mut INT16).offset(0) = (rgb >> 16i32) as INT16;
        outptr1 = outptr1.offset(4);
        col -= 1
    }
    if (*cinfo).output_width & 1u32 != 0 {
...
pub unsafe extern "C" fn h2v2_merged_upsample_565D_le(
    ...
    let mut d0: JLONG = dither_matrix[((*cinfo).output_scanline & DITHER_MASK as c_uint) as usize];
    let mut d1: JLONG =
        dither_matrix[((*cinfo).output_scanline + 1u32 & DITHER_MASK as c_uint) as usize];
    ...
    while col > 0u32 {
        ...
        *(outptr0 as *mut INT16).offset(1) = (rgb >> 16i32) as INT16;
        ...
        inptr01 = inptr01.offset(1);
        y = *fresh102 as c_int;
        r = *range_limit.offset(((y + cred) as c_long + (d1 & 0xffi64)) as isize) as c_uint;
        g = *range_limit.offset(((y + cgreen) as c_long + ((d1 & 0xffi64) >> 1i32)) as isize)
            as c_uint;
        b = *range_limit.offset(((y + cblue) as c_long + (d1 & 0xffi64)) as isize) as c_uint;
