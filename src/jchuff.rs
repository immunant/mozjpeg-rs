use libc::c_uint;use libc::c_double;use libc::c_char;use libc::c_long;use libc::c_ulong;use libc::c_void;use libc::c_int;extern "C" {
    #[no_mangle]
...
use super::simd::x86_64::jsimd::jsimd_can_huff_encode_one_block;
use super::simd::x86_64::jsimd::jsimd_huff_encode_one_block;
