...
unsafe extern "C" fn start_pass_huff(
    ...
    while ci < (*cinfo).comps_in_scan {
     ...
     (*cinfo).cur_comp_info[ci as usize]; let mut dctbl:   libc::c_int =  (*compptr).dc_tbl_no; let mut actbl:   libc::c_int =  (*compptr).ac_tbl_no;
        if gather_statistics != 0 {
...
pub unsafe extern "C" fn jpeg_make_c_derived_tbl(
    ...
    if (*pdtbl).is_null() {
     ...
     let mut dtbl:   *mut crate::src::jchuff::c_derived_tbl =  *pdtbl; let mut p:   libc::c_int =  0i32; let mut l:   libc::c_int =  1i32;
    while l <= 16i32 {
    ...
    huffsize[p as usize] = 0i8;
     ...
     let mut lastp:   libc::c_int =  p; let mut code:   libc::c_uint =  0u32; let mut si:   libc::c_int =  huffsize[0] as libc::c_int;
    p = 0i32;
     ...
     */
     let mut maxsymbol:   libc::c_int =  if isDC != 0 { 15i32 } else { 255i32 };
    p = 0i32;
    while p < lastp {
...
unsafe extern "C" fn flush_bits(mut state: *mut working_state) -> crate::jmorecfg_h::boolean {
     ...
     let mut put_buffer:   crate::stddef_h::size_t =  (*state).cur.put_buffer; let mut put_bits:   libc::c_int =  (*state).cur.put_bits;
    ...
    while put_bits >= 8i32 {
        ...
        put_bits -= 8i32;
         let mut c:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
        let fresh3 = buffer;
    ...
    if localbuf != 0 {
          let mut bytes:   crate::stddef_h::size_t =
      buffer.wrapping_offset_from(_buffer.as_mut_ptr())
            as crate::stddef_h::size_t;
        buffer = _buffer.as_mut_ptr();
        while bytes > 0u64 {
              let mut bytestocopy:   crate::stddef_h::size_t =
     if bytes < (*state).free_in_buffer {
                bytes
            } else {
...
unsafe extern "C" fn encode_one_block(
     ...
     * Agner Fog.
     */
     let mut temp2:   libc::c_int =  *block.offset(0) as libc::c_int - last_dc_val; let mut temp:   libc::c_int =  temp2; let mut temp3:   libc::c_int =
     temp
    ...
    temp2 += temp3;
     ...
     crate::jpeg_nbits_table_h::jpeg_nbits_table[temp as usize] as libc::c_int; let mut code:   libc::c_int =  (*dctbl).ehufco[nbits as usize] as libc::c_int; let mut size:   libc::c_int =  (*dctbl).ehufsi[nbits as usize] as libc::c_int;
    if put_bits > 47i32 {
     ...
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
        ...
        *fresh5 = c;
        ...
        put_bits -= 8i32;
         let mut c_0:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
        let fresh7 = buffer;
        buffer = buffer.offset(1);
        *fresh7 = c_0;
        ...
        put_bits -= 8i32;
         let mut c_1:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
        let fresh9 = buffer;
        buffer = buffer.offset(1);
        *fresh9 = c_1;
        ...
        put_bits -= 8i32;
         let mut c_2:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
        let fresh11 = buffer;
        buffer = buffer.offset(1);
        *fresh11 = c_2;
        ...
        put_bits -= 8i32;
         let mut c_3:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
        let fresh13 = buffer;
        buffer = buffer.offset(1);
        *fresh13 = c_3;
        ...
        put_bits -= 8i32;
         let mut c_4:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
        let fresh15 = buffer;
        buffer = buffer.offset(1);
        *fresh15 = c_4;
    ...
    if put_bits > 47i32 {
        ...
        put_bits -= 8i32;
         let mut c_5:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
        let fresh17 = buffer;
        buffer = buffer.offset(1);
        *fresh17 = c_5;
        ...
        put_bits -= 8i32;
         let mut c_6:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
        let fresh19 = buffer;
        buffer = buffer.offset(1);
        *fresh19 = c_6;
        ...
        put_bits -= 8i32;
         let mut c_7:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
        let fresh21 = buffer;
        buffer = buffer.offset(1);
        *fresh21 = c_7;
        ...
        put_bits -= 8i32;
         let mut c_8:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
        let fresh23 = buffer;
        buffer = buffer.offset(1);
        *fresh23 = c_8;
        ...
        put_bits -= 8i32;
         let mut c_9:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
        let fresh25 = buffer;
        buffer = buffer.offset(1);
        *fresh25 = c_9;
        ...
        put_bits -= 8i32;
         let mut c_10:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
        let fresh27 = buffer;
        buffer = buffer.offset(1);
        *fresh27 = c_10;
    ...
    put_buffer = put_buffer << nbits | temp2 as libc::c_ulong;
     let mut r:   libc::c_int =  0i32; /* r = run length of zeros */
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_11:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh29 = buffer;
                buffer = buffer.offset(1);
                *fresh29 = c_11;
                ...
                put_bits -= 8i32;
                 let mut c_12:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh31 = buffer;
                buffer = buffer.offset(1);
                *fresh31 = c_12;
                ...
                put_bits -= 8i32;
                 let mut c_13:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh33 = buffer;
                buffer = buffer.offset(1);
                *fresh33 = c_13;
                ...
                put_bits -= 8i32;
                 let mut c_14:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh35 = buffer;
                buffer = buffer.offset(1);
                *fresh35 = c_14;
                ...
                put_bits -= 8i32;
                 let mut c_15:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh37 = buffer;
                buffer = buffer.offset(1);
                *fresh37 = c_15;
                ...
                put_bits -= 8i32;
                 let mut c_16:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh39 = buffer;
                buffer = buffer.offset(1);
                *fresh39 = c_16;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_17:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh41 = buffer;
            buffer = buffer.offset(1);
            *fresh41 = c_17;
            ...
            put_bits -= 8i32;
             let mut c_18:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh43 = buffer;
            buffer = buffer.offset(1);
            *fresh43 = c_18;
            ...
            put_bits -= 8i32;
             let mut c_19:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh45 = buffer;
            buffer = buffer.offset(1);
            *fresh45 = c_19;
            ...
            put_bits -= 8i32;
             let mut c_20:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh47 = buffer;
            buffer = buffer.offset(1);
            *fresh47 = c_20;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_21:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh49 = buffer;
                buffer = buffer.offset(1);
                *fresh49 = c_21;
                ...
                put_bits -= 8i32;
                 let mut c_22:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh51 = buffer;
                buffer = buffer.offset(1);
                *fresh51 = c_22;
                ...
                put_bits -= 8i32;
                 let mut c_23:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh53 = buffer;
                buffer = buffer.offset(1);
                *fresh53 = c_23;
                ...
                put_bits -= 8i32;
                 let mut c_24:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh55 = buffer;
                buffer = buffer.offset(1);
                *fresh55 = c_24;
                ...
                put_bits -= 8i32;
                 let mut c_25:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh57 = buffer;
                buffer = buffer.offset(1);
                *fresh57 = c_25;
                ...
                put_bits -= 8i32;
                 let mut c_26:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh59 = buffer;
                buffer = buffer.offset(1);
                *fresh59 = c_26;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_27:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh61 = buffer;
            buffer = buffer.offset(1);
            *fresh61 = c_27;
            ...
            put_bits -= 8i32;
             let mut c_28:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh63 = buffer;
            buffer = buffer.offset(1);
            *fresh63 = c_28;
            ...
            put_bits -= 8i32;
             let mut c_29:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh65 = buffer;
            buffer = buffer.offset(1);
            *fresh65 = c_29;
            ...
            put_bits -= 8i32;
             let mut c_30:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh67 = buffer;
            buffer = buffer.offset(1);
            *fresh67 = c_30;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_31:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh69 = buffer;
                buffer = buffer.offset(1);
                *fresh69 = c_31;
                ...
                put_bits -= 8i32;
                 let mut c_32:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh71 = buffer;
                buffer = buffer.offset(1);
                *fresh71 = c_32;
                ...
                put_bits -= 8i32;
                 let mut c_33:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh73 = buffer;
                buffer = buffer.offset(1);
                *fresh73 = c_33;
                ...
                put_bits -= 8i32;
                 let mut c_34:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh75 = buffer;
                buffer = buffer.offset(1);
                *fresh75 = c_34;
                ...
                put_bits -= 8i32;
                 let mut c_35:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh77 = buffer;
                buffer = buffer.offset(1);
                *fresh77 = c_35;
                ...
                put_bits -= 8i32;
                 let mut c_36:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh79 = buffer;
                buffer = buffer.offset(1);
                *fresh79 = c_36;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_37:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh81 = buffer;
            buffer = buffer.offset(1);
            *fresh81 = c_37;
            ...
            put_bits -= 8i32;
             let mut c_38:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh83 = buffer;
            buffer = buffer.offset(1);
            *fresh83 = c_38;
            ...
            put_bits -= 8i32;
             let mut c_39:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh85 = buffer;
            buffer = buffer.offset(1);
            *fresh85 = c_39;
            ...
            put_bits -= 8i32;
             let mut c_40:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh87 = buffer;
            buffer = buffer.offset(1);
            *fresh87 = c_40;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_41:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh89 = buffer;
                buffer = buffer.offset(1);
                *fresh89 = c_41;
                ...
                put_bits -= 8i32;
                 let mut c_42:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh91 = buffer;
                buffer = buffer.offset(1);
                *fresh91 = c_42;
                ...
                put_bits -= 8i32;
                 let mut c_43:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh93 = buffer;
                buffer = buffer.offset(1);
                *fresh93 = c_43;
                ...
                put_bits -= 8i32;
                 let mut c_44:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh95 = buffer;
                buffer = buffer.offset(1);
                *fresh95 = c_44;
                ...
                put_bits -= 8i32;
                 let mut c_45:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh97 = buffer;
                buffer = buffer.offset(1);
                *fresh97 = c_45;
                ...
                put_bits -= 8i32;
                 let mut c_46:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh99 = buffer;
                buffer = buffer.offset(1);
                *fresh99 = c_46;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_47:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh101 = buffer;
            buffer = buffer.offset(1);
            *fresh101 = c_47;
            ...
            put_bits -= 8i32;
             let mut c_48:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh103 = buffer;
            buffer = buffer.offset(1);
            *fresh103 = c_48;
            ...
            put_bits -= 8i32;
             let mut c_49:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh105 = buffer;
            buffer = buffer.offset(1);
            *fresh105 = c_49;
            ...
            put_bits -= 8i32;
             let mut c_50:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh107 = buffer;
            buffer = buffer.offset(1);
            *fresh107 = c_50;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_51:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh109 = buffer;
                buffer = buffer.offset(1);
                *fresh109 = c_51;
                ...
                put_bits -= 8i32;
                 let mut c_52:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh111 = buffer;
                buffer = buffer.offset(1);
                *fresh111 = c_52;
                ...
                put_bits -= 8i32;
                 let mut c_53:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh113 = buffer;
                buffer = buffer.offset(1);
                *fresh113 = c_53;
                ...
                put_bits -= 8i32;
                 let mut c_54:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh115 = buffer;
                buffer = buffer.offset(1);
                *fresh115 = c_54;
                ...
                put_bits -= 8i32;
                 let mut c_55:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh117 = buffer;
                buffer = buffer.offset(1);
                *fresh117 = c_55;
                ...
                put_bits -= 8i32;
                 let mut c_56:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh119 = buffer;
                buffer = buffer.offset(1);
                *fresh119 = c_56;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_57:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh121 = buffer;
            buffer = buffer.offset(1);
            *fresh121 = c_57;
            ...
            put_bits -= 8i32;
             let mut c_58:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh123 = buffer;
            buffer = buffer.offset(1);
            *fresh123 = c_58;
            ...
            put_bits -= 8i32;
             let mut c_59:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh125 = buffer;
            buffer = buffer.offset(1);
            *fresh125 = c_59;
            ...
            put_bits -= 8i32;
             let mut c_60:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh127 = buffer;
            buffer = buffer.offset(1);
            *fresh127 = c_60;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_61:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh129 = buffer;
                buffer = buffer.offset(1);
                *fresh129 = c_61;
                ...
                put_bits -= 8i32;
                 let mut c_62:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh131 = buffer;
                buffer = buffer.offset(1);
                *fresh131 = c_62;
                ...
                put_bits -= 8i32;
                 let mut c_63:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh133 = buffer;
                buffer = buffer.offset(1);
                *fresh133 = c_63;
                ...
                put_bits -= 8i32;
                 let mut c_64:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh135 = buffer;
                buffer = buffer.offset(1);
                *fresh135 = c_64;
                ...
                put_bits -= 8i32;
                 let mut c_65:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh137 = buffer;
                buffer = buffer.offset(1);
                *fresh137 = c_65;
                ...
                put_bits -= 8i32;
                 let mut c_66:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh139 = buffer;
                buffer = buffer.offset(1);
                *fresh139 = c_66;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_67:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh141 = buffer;
            buffer = buffer.offset(1);
            *fresh141 = c_67;
            ...
            put_bits -= 8i32;
             let mut c_68:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh143 = buffer;
            buffer = buffer.offset(1);
            *fresh143 = c_68;
            ...
            put_bits -= 8i32;
             let mut c_69:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh145 = buffer;
            buffer = buffer.offset(1);
            *fresh145 = c_69;
            ...
            put_bits -= 8i32;
             let mut c_70:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh147 = buffer;
            buffer = buffer.offset(1);
            *fresh147 = c_70;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_71:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh149 = buffer;
                buffer = buffer.offset(1);
                *fresh149 = c_71;
                ...
                put_bits -= 8i32;
                 let mut c_72:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh151 = buffer;
                buffer = buffer.offset(1);
                *fresh151 = c_72;
                ...
                put_bits -= 8i32;
                 let mut c_73:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh153 = buffer;
                buffer = buffer.offset(1);
                *fresh153 = c_73;
                ...
                put_bits -= 8i32;
                 let mut c_74:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh155 = buffer;
                buffer = buffer.offset(1);
                *fresh155 = c_74;
                ...
                put_bits -= 8i32;
                 let mut c_75:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh157 = buffer;
                buffer = buffer.offset(1);
                *fresh157 = c_75;
                ...
                put_bits -= 8i32;
                 let mut c_76:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh159 = buffer;
                buffer = buffer.offset(1);
                *fresh159 = c_76;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_77:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh161 = buffer;
            buffer = buffer.offset(1);
            *fresh161 = c_77;
            ...
            put_bits -= 8i32;
             let mut c_78:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh163 = buffer;
            buffer = buffer.offset(1);
            *fresh163 = c_78;
            ...
            put_bits -= 8i32;
             let mut c_79:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh165 = buffer;
            buffer = buffer.offset(1);
            *fresh165 = c_79;
            ...
            put_bits -= 8i32;
             let mut c_80:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh167 = buffer;
            buffer = buffer.offset(1);
            *fresh167 = c_80;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_81:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh169 = buffer;
                buffer = buffer.offset(1);
                *fresh169 = c_81;
                ...
                put_bits -= 8i32;
                 let mut c_82:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh171 = buffer;
                buffer = buffer.offset(1);
                *fresh171 = c_82;
                ...
                put_bits -= 8i32;
                 let mut c_83:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh173 = buffer;
                buffer = buffer.offset(1);
                *fresh173 = c_83;
                ...
                put_bits -= 8i32;
                 let mut c_84:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh175 = buffer;
                buffer = buffer.offset(1);
                *fresh175 = c_84;
                ...
                put_bits -= 8i32;
                 let mut c_85:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh177 = buffer;
                buffer = buffer.offset(1);
                *fresh177 = c_85;
                ...
                put_bits -= 8i32;
                 let mut c_86:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh179 = buffer;
                buffer = buffer.offset(1);
                *fresh179 = c_86;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_87:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh181 = buffer;
            buffer = buffer.offset(1);
            *fresh181 = c_87;
            ...
            put_bits -= 8i32;
             let mut c_88:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh183 = buffer;
            buffer = buffer.offset(1);
            *fresh183 = c_88;
            ...
            put_bits -= 8i32;
             let mut c_89:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh185 = buffer;
            buffer = buffer.offset(1);
            *fresh185 = c_89;
            ...
            put_bits -= 8i32;
             let mut c_90:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh187 = buffer;
            buffer = buffer.offset(1);
            *fresh187 = c_90;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_91:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh189 = buffer;
                buffer = buffer.offset(1);
                *fresh189 = c_91;
                ...
                put_bits -= 8i32;
                 let mut c_92:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh191 = buffer;
                buffer = buffer.offset(1);
                *fresh191 = c_92;
                ...
                put_bits -= 8i32;
                 let mut c_93:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh193 = buffer;
                buffer = buffer.offset(1);
                *fresh193 = c_93;
                ...
                put_bits -= 8i32;
                 let mut c_94:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh195 = buffer;
                buffer = buffer.offset(1);
                *fresh195 = c_94;
                ...
                put_bits -= 8i32;
                 let mut c_95:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh197 = buffer;
                buffer = buffer.offset(1);
                *fresh197 = c_95;
                ...
                put_bits -= 8i32;
                 let mut c_96:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh199 = buffer;
                buffer = buffer.offset(1);
                *fresh199 = c_96;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_97:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh201 = buffer;
            buffer = buffer.offset(1);
            *fresh201 = c_97;
            ...
            put_bits -= 8i32;
             let mut c_98:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh203 = buffer;
            buffer = buffer.offset(1);
            *fresh203 = c_98;
            ...
            put_bits -= 8i32;
             let mut c_99:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh205 = buffer;
            buffer = buffer.offset(1);
            *fresh205 = c_99;
            ...
            put_bits -= 8i32;
             let mut c_100:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh207 = buffer;
            buffer = buffer.offset(1);
            *fresh207 = c_100;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_101:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh209 = buffer;
                buffer = buffer.offset(1);
                *fresh209 = c_101;
                ...
                put_bits -= 8i32;
                 let mut c_102:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh211 = buffer;
                buffer = buffer.offset(1);
                *fresh211 = c_102;
                ...
                put_bits -= 8i32;
                 let mut c_103:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh213 = buffer;
                buffer = buffer.offset(1);
                *fresh213 = c_103;
                ...
                put_bits -= 8i32;
                 let mut c_104:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh215 = buffer;
                buffer = buffer.offset(1);
                *fresh215 = c_104;
                ...
                put_bits -= 8i32;
                 let mut c_105:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh217 = buffer;
                buffer = buffer.offset(1);
                *fresh217 = c_105;
                ...
                put_bits -= 8i32;
                 let mut c_106:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh219 = buffer;
                buffer = buffer.offset(1);
                *fresh219 = c_106;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_107:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh221 = buffer;
            buffer = buffer.offset(1);
            *fresh221 = c_107;
            ...
            put_bits -= 8i32;
             let mut c_108:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh223 = buffer;
            buffer = buffer.offset(1);
            *fresh223 = c_108;
            ...
            put_bits -= 8i32;
             let mut c_109:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh225 = buffer;
            buffer = buffer.offset(1);
            *fresh225 = c_109;
            ...
            put_bits -= 8i32;
             let mut c_110:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh227 = buffer;
            buffer = buffer.offset(1);
            *fresh227 = c_110;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_111:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh229 = buffer;
                buffer = buffer.offset(1);
                *fresh229 = c_111;
                ...
                put_bits -= 8i32;
                 let mut c_112:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh231 = buffer;
                buffer = buffer.offset(1);
                *fresh231 = c_112;
                ...
                put_bits -= 8i32;
                 let mut c_113:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh233 = buffer;
                buffer = buffer.offset(1);
                *fresh233 = c_113;
                ...
                put_bits -= 8i32;
                 let mut c_114:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh235 = buffer;
                buffer = buffer.offset(1);
                *fresh235 = c_114;
                ...
                put_bits -= 8i32;
                 let mut c_115:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh237 = buffer;
                buffer = buffer.offset(1);
                *fresh237 = c_115;
                ...
                put_bits -= 8i32;
                 let mut c_116:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh239 = buffer;
                buffer = buffer.offset(1);
                *fresh239 = c_116;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_117:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh241 = buffer;
            buffer = buffer.offset(1);
            *fresh241 = c_117;
            ...
            put_bits -= 8i32;
             let mut c_118:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh243 = buffer;
            buffer = buffer.offset(1);
            *fresh243 = c_118;
            ...
            put_bits -= 8i32;
             let mut c_119:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh245 = buffer;
            buffer = buffer.offset(1);
            *fresh245 = c_119;
            ...
            put_bits -= 8i32;
             let mut c_120:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh247 = buffer;
            buffer = buffer.offset(1);
            *fresh247 = c_120;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_121:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh249 = buffer;
                buffer = buffer.offset(1);
                *fresh249 = c_121;
                ...
                put_bits -= 8i32;
                 let mut c_122:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh251 = buffer;
                buffer = buffer.offset(1);
                *fresh251 = c_122;
                ...
                put_bits -= 8i32;
                 let mut c_123:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh253 = buffer;
                buffer = buffer.offset(1);
                *fresh253 = c_123;
                ...
                put_bits -= 8i32;
                 let mut c_124:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh255 = buffer;
                buffer = buffer.offset(1);
                *fresh255 = c_124;
                ...
                put_bits -= 8i32;
                 let mut c_125:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh257 = buffer;
                buffer = buffer.offset(1);
                *fresh257 = c_125;
                ...
                put_bits -= 8i32;
                 let mut c_126:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh259 = buffer;
                buffer = buffer.offset(1);
                *fresh259 = c_126;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_127:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh261 = buffer;
            buffer = buffer.offset(1);
            *fresh261 = c_127;
            ...
            put_bits -= 8i32;
             let mut c_128:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh263 = buffer;
            buffer = buffer.offset(1);
            *fresh263 = c_128;
            ...
            put_bits -= 8i32;
             let mut c_129:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh265 = buffer;
            buffer = buffer.offset(1);
            *fresh265 = c_129;
            ...
            put_bits -= 8i32;
             let mut c_130:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh267 = buffer;
            buffer = buffer.offset(1);
            *fresh267 = c_130;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_131:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh269 = buffer;
                buffer = buffer.offset(1);
                *fresh269 = c_131;
                ...
                put_bits -= 8i32;
                 let mut c_132:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh271 = buffer;
                buffer = buffer.offset(1);
                *fresh271 = c_132;
                ...
                put_bits -= 8i32;
                 let mut c_133:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh273 = buffer;
                buffer = buffer.offset(1);
                *fresh273 = c_133;
                ...
                put_bits -= 8i32;
                 let mut c_134:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh275 = buffer;
                buffer = buffer.offset(1);
                *fresh275 = c_134;
                ...
                put_bits -= 8i32;
                 let mut c_135:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh277 = buffer;
                buffer = buffer.offset(1);
                *fresh277 = c_135;
                ...
                put_bits -= 8i32;
                 let mut c_136:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh279 = buffer;
                buffer = buffer.offset(1);
                *fresh279 = c_136;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_137:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh281 = buffer;
            buffer = buffer.offset(1);
            *fresh281 = c_137;
            ...
            put_bits -= 8i32;
             let mut c_138:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh283 = buffer;
            buffer = buffer.offset(1);
            *fresh283 = c_138;
            ...
            put_bits -= 8i32;
             let mut c_139:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh285 = buffer;
            buffer = buffer.offset(1);
            *fresh285 = c_139;
            ...
            put_bits -= 8i32;
             let mut c_140:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh287 = buffer;
            buffer = buffer.offset(1);
            *fresh287 = c_140;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_141:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh289 = buffer;
                buffer = buffer.offset(1);
                *fresh289 = c_141;
                ...
                put_bits -= 8i32;
                 let mut c_142:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh291 = buffer;
                buffer = buffer.offset(1);
                *fresh291 = c_142;
                ...
                put_bits -= 8i32;
                 let mut c_143:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh293 = buffer;
                buffer = buffer.offset(1);
                *fresh293 = c_143;
                ...
                put_bits -= 8i32;
                 let mut c_144:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh295 = buffer;
                buffer = buffer.offset(1);
                *fresh295 = c_144;
                ...
                put_bits -= 8i32;
                 let mut c_145:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh297 = buffer;
                buffer = buffer.offset(1);
                *fresh297 = c_145;
                ...
                put_bits -= 8i32;
                 let mut c_146:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh299 = buffer;
                buffer = buffer.offset(1);
                *fresh299 = c_146;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_147:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh301 = buffer;
            buffer = buffer.offset(1);
            *fresh301 = c_147;
            ...
            put_bits -= 8i32;
             let mut c_148:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh303 = buffer;
            buffer = buffer.offset(1);
            *fresh303 = c_148;
            ...
            put_bits -= 8i32;
             let mut c_149:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh305 = buffer;
            buffer = buffer.offset(1);
            *fresh305 = c_149;
            ...
            put_bits -= 8i32;
             let mut c_150:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh307 = buffer;
            buffer = buffer.offset(1);
            *fresh307 = c_150;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_151:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh309 = buffer;
                buffer = buffer.offset(1);
                *fresh309 = c_151;
                ...
                put_bits -= 8i32;
                 let mut c_152:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh311 = buffer;
                buffer = buffer.offset(1);
                *fresh311 = c_152;
                ...
                put_bits -= 8i32;
                 let mut c_153:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh313 = buffer;
                buffer = buffer.offset(1);
                *fresh313 = c_153;
                ...
                put_bits -= 8i32;
                 let mut c_154:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh315 = buffer;
                buffer = buffer.offset(1);
                *fresh315 = c_154;
                ...
                put_bits -= 8i32;
                 let mut c_155:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh317 = buffer;
                buffer = buffer.offset(1);
                *fresh317 = c_155;
                ...
                put_bits -= 8i32;
                 let mut c_156:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh319 = buffer;
                buffer = buffer.offset(1);
                *fresh319 = c_156;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_157:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh321 = buffer;
            buffer = buffer.offset(1);
            *fresh321 = c_157;
            ...
            put_bits -= 8i32;
             let mut c_158:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh323 = buffer;
            buffer = buffer.offset(1);
            *fresh323 = c_158;
            ...
            put_bits -= 8i32;
             let mut c_159:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh325 = buffer;
            buffer = buffer.offset(1);
            *fresh325 = c_159;
            ...
            put_bits -= 8i32;
             let mut c_160:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh327 = buffer;
            buffer = buffer.offset(1);
            *fresh327 = c_160;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_161:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh329 = buffer;
                buffer = buffer.offset(1);
                *fresh329 = c_161;
                ...
                put_bits -= 8i32;
                 let mut c_162:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh331 = buffer;
                buffer = buffer.offset(1);
                *fresh331 = c_162;
                ...
                put_bits -= 8i32;
                 let mut c_163:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh333 = buffer;
                buffer = buffer.offset(1);
                *fresh333 = c_163;
                ...
                put_bits -= 8i32;
                 let mut c_164:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh335 = buffer;
                buffer = buffer.offset(1);
                *fresh335 = c_164;
                ...
                put_bits -= 8i32;
                 let mut c_165:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh337 = buffer;
                buffer = buffer.offset(1);
                *fresh337 = c_165;
                ...
                put_bits -= 8i32;
                 let mut c_166:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh339 = buffer;
                buffer = buffer.offset(1);
                *fresh339 = c_166;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_167:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh341 = buffer;
            buffer = buffer.offset(1);
            *fresh341 = c_167;
            ...
            put_bits -= 8i32;
             let mut c_168:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh343 = buffer;
            buffer = buffer.offset(1);
            *fresh343 = c_168;
            ...
            put_bits -= 8i32;
             let mut c_169:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh345 = buffer;
            buffer = buffer.offset(1);
            *fresh345 = c_169;
            ...
            put_bits -= 8i32;
             let mut c_170:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh347 = buffer;
            buffer = buffer.offset(1);
            *fresh347 = c_170;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_171:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh349 = buffer;
                buffer = buffer.offset(1);
                *fresh349 = c_171;
                ...
                put_bits -= 8i32;
                 let mut c_172:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh351 = buffer;
                buffer = buffer.offset(1);
                *fresh351 = c_172;
                ...
                put_bits -= 8i32;
                 let mut c_173:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh353 = buffer;
                buffer = buffer.offset(1);
                *fresh353 = c_173;
                ...
                put_bits -= 8i32;
                 let mut c_174:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh355 = buffer;
                buffer = buffer.offset(1);
                *fresh355 = c_174;
                ...
                put_bits -= 8i32;
                 let mut c_175:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh357 = buffer;
                buffer = buffer.offset(1);
                *fresh357 = c_175;
                ...
                put_bits -= 8i32;
                 let mut c_176:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh359 = buffer;
                buffer = buffer.offset(1);
                *fresh359 = c_176;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_177:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh361 = buffer;
            buffer = buffer.offset(1);
            *fresh361 = c_177;
            ...
            put_bits -= 8i32;
             let mut c_178:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh363 = buffer;
            buffer = buffer.offset(1);
            *fresh363 = c_178;
            ...
            put_bits -= 8i32;
             let mut c_179:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh365 = buffer;
            buffer = buffer.offset(1);
            *fresh365 = c_179;
            ...
            put_bits -= 8i32;
             let mut c_180:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh367 = buffer;
            buffer = buffer.offset(1);
            *fresh367 = c_180;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_181:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh369 = buffer;
                buffer = buffer.offset(1);
                *fresh369 = c_181;
                ...
                put_bits -= 8i32;
                 let mut c_182:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh371 = buffer;
                buffer = buffer.offset(1);
                *fresh371 = c_182;
                ...
                put_bits -= 8i32;
                 let mut c_183:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh373 = buffer;
                buffer = buffer.offset(1);
                *fresh373 = c_183;
                ...
                put_bits -= 8i32;
                 let mut c_184:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh375 = buffer;
                buffer = buffer.offset(1);
                *fresh375 = c_184;
                ...
                put_bits -= 8i32;
                 let mut c_185:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh377 = buffer;
                buffer = buffer.offset(1);
                *fresh377 = c_185;
                ...
                put_bits -= 8i32;
                 let mut c_186:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh379 = buffer;
                buffer = buffer.offset(1);
                *fresh379 = c_186;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_187:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh381 = buffer;
            buffer = buffer.offset(1);
            *fresh381 = c_187;
            ...
            put_bits -= 8i32;
             let mut c_188:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh383 = buffer;
            buffer = buffer.offset(1);
            *fresh383 = c_188;
            ...
            put_bits -= 8i32;
             let mut c_189:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh385 = buffer;
            buffer = buffer.offset(1);
            *fresh385 = c_189;
            ...
            put_bits -= 8i32;
             let mut c_190:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh387 = buffer;
            buffer = buffer.offset(1);
            *fresh387 = c_190;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_191:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh389 = buffer;
                buffer = buffer.offset(1);
                *fresh389 = c_191;
                ...
                put_bits -= 8i32;
                 let mut c_192:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh391 = buffer;
                buffer = buffer.offset(1);
                *fresh391 = c_192;
                ...
                put_bits -= 8i32;
                 let mut c_193:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh393 = buffer;
                buffer = buffer.offset(1);
                *fresh393 = c_193;
                ...
                put_bits -= 8i32;
                 let mut c_194:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh395 = buffer;
                buffer = buffer.offset(1);
                *fresh395 = c_194;
                ...
                put_bits -= 8i32;
                 let mut c_195:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh397 = buffer;
                buffer = buffer.offset(1);
                *fresh397 = c_195;
                ...
                put_bits -= 8i32;
                 let mut c_196:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh399 = buffer;
                buffer = buffer.offset(1);
                *fresh399 = c_196;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_197:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh401 = buffer;
            buffer = buffer.offset(1);
            *fresh401 = c_197;
            ...
            put_bits -= 8i32;
             let mut c_198:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh403 = buffer;
            buffer = buffer.offset(1);
            *fresh403 = c_198;
            ...
            put_bits -= 8i32;
             let mut c_199:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh405 = buffer;
            buffer = buffer.offset(1);
            *fresh405 = c_199;
            ...
            put_bits -= 8i32;
             let mut c_200:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh407 = buffer;
            buffer = buffer.offset(1);
            *fresh407 = c_200;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_201:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh409 = buffer;
                buffer = buffer.offset(1);
                *fresh409 = c_201;
                ...
                put_bits -= 8i32;
                 let mut c_202:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh411 = buffer;
                buffer = buffer.offset(1);
                *fresh411 = c_202;
                ...
                put_bits -= 8i32;
                 let mut c_203:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh413 = buffer;
                buffer = buffer.offset(1);
                *fresh413 = c_203;
                ...
                put_bits -= 8i32;
                 let mut c_204:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh415 = buffer;
                buffer = buffer.offset(1);
                *fresh415 = c_204;
                ...
                put_bits -= 8i32;
                 let mut c_205:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh417 = buffer;
                buffer = buffer.offset(1);
                *fresh417 = c_205;
                ...
                put_bits -= 8i32;
                 let mut c_206:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh419 = buffer;
                buffer = buffer.offset(1);
                *fresh419 = c_206;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_207:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh421 = buffer;
            buffer = buffer.offset(1);
            *fresh421 = c_207;
            ...
            put_bits -= 8i32;
             let mut c_208:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh423 = buffer;
            buffer = buffer.offset(1);
            *fresh423 = c_208;
            ...
            put_bits -= 8i32;
             let mut c_209:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh425 = buffer;
            buffer = buffer.offset(1);
            *fresh425 = c_209;
            ...
            put_bits -= 8i32;
             let mut c_210:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh427 = buffer;
            buffer = buffer.offset(1);
            *fresh427 = c_210;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_211:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh429 = buffer;
                buffer = buffer.offset(1);
                *fresh429 = c_211;
                ...
                put_bits -= 8i32;
                 let mut c_212:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh431 = buffer;
                buffer = buffer.offset(1);
                *fresh431 = c_212;
                ...
                put_bits -= 8i32;
                 let mut c_213:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh433 = buffer;
                buffer = buffer.offset(1);
                *fresh433 = c_213;
                ...
                put_bits -= 8i32;
                 let mut c_214:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh435 = buffer;
                buffer = buffer.offset(1);
                *fresh435 = c_214;
                ...
                put_bits -= 8i32;
                 let mut c_215:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh437 = buffer;
                buffer = buffer.offset(1);
                *fresh437 = c_215;
                ...
                put_bits -= 8i32;
                 let mut c_216:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh439 = buffer;
                buffer = buffer.offset(1);
                *fresh439 = c_216;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_217:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh441 = buffer;
            buffer = buffer.offset(1);
            *fresh441 = c_217;
            ...
            put_bits -= 8i32;
             let mut c_218:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh443 = buffer;
            buffer = buffer.offset(1);
            *fresh443 = c_218;
            ...
            put_bits -= 8i32;
             let mut c_219:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh445 = buffer;
            buffer = buffer.offset(1);
            *fresh445 = c_219;
            ...
            put_bits -= 8i32;
             let mut c_220:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh447 = buffer;
            buffer = buffer.offset(1);
            *fresh447 = c_220;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_221:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh449 = buffer;
                buffer = buffer.offset(1);
                *fresh449 = c_221;
                ...
                put_bits -= 8i32;
                 let mut c_222:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh451 = buffer;
                buffer = buffer.offset(1);
                *fresh451 = c_222;
                ...
                put_bits -= 8i32;
                 let mut c_223:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh453 = buffer;
                buffer = buffer.offset(1);
                *fresh453 = c_223;
                ...
                put_bits -= 8i32;
                 let mut c_224:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh455 = buffer;
                buffer = buffer.offset(1);
                *fresh455 = c_224;
                ...
                put_bits -= 8i32;
                 let mut c_225:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh457 = buffer;
                buffer = buffer.offset(1);
                *fresh457 = c_225;
                ...
                put_bits -= 8i32;
                 let mut c_226:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh459 = buffer;
                buffer = buffer.offset(1);
                *fresh459 = c_226;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_227:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh461 = buffer;
            buffer = buffer.offset(1);
            *fresh461 = c_227;
            ...
            put_bits -= 8i32;
             let mut c_228:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh463 = buffer;
            buffer = buffer.offset(1);
            *fresh463 = c_228;
            ...
            put_bits -= 8i32;
             let mut c_229:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh465 = buffer;
            buffer = buffer.offset(1);
            *fresh465 = c_229;
            ...
            put_bits -= 8i32;
             let mut c_230:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh467 = buffer;
            buffer = buffer.offset(1);
            *fresh467 = c_230;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_231:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh469 = buffer;
                buffer = buffer.offset(1);
                *fresh469 = c_231;
                ...
                put_bits -= 8i32;
                 let mut c_232:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh471 = buffer;
                buffer = buffer.offset(1);
                *fresh471 = c_232;
                ...
                put_bits -= 8i32;
                 let mut c_233:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh473 = buffer;
                buffer = buffer.offset(1);
                *fresh473 = c_233;
                ...
                put_bits -= 8i32;
                 let mut c_234:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh475 = buffer;
                buffer = buffer.offset(1);
                *fresh475 = c_234;
                ...
                put_bits -= 8i32;
                 let mut c_235:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh477 = buffer;
                buffer = buffer.offset(1);
                *fresh477 = c_235;
                ...
                put_bits -= 8i32;
                 let mut c_236:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh479 = buffer;
                buffer = buffer.offset(1);
                *fresh479 = c_236;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_237:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh481 = buffer;
            buffer = buffer.offset(1);
            *fresh481 = c_237;
            ...
            put_bits -= 8i32;
             let mut c_238:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh483 = buffer;
            buffer = buffer.offset(1);
            *fresh483 = c_238;
            ...
            put_bits -= 8i32;
             let mut c_239:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh485 = buffer;
            buffer = buffer.offset(1);
            *fresh485 = c_239;
            ...
            put_bits -= 8i32;
             let mut c_240:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh487 = buffer;
            buffer = buffer.offset(1);
            *fresh487 = c_240;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_241:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh489 = buffer;
                buffer = buffer.offset(1);
                *fresh489 = c_241;
                ...
                put_bits -= 8i32;
                 let mut c_242:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh491 = buffer;
                buffer = buffer.offset(1);
                *fresh491 = c_242;
                ...
                put_bits -= 8i32;
                 let mut c_243:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh493 = buffer;
                buffer = buffer.offset(1);
                *fresh493 = c_243;
                ...
                put_bits -= 8i32;
                 let mut c_244:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh495 = buffer;
                buffer = buffer.offset(1);
                *fresh495 = c_244;
                ...
                put_bits -= 8i32;
                 let mut c_245:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh497 = buffer;
                buffer = buffer.offset(1);
                *fresh497 = c_245;
                ...
                put_bits -= 8i32;
                 let mut c_246:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh499 = buffer;
                buffer = buffer.offset(1);
                *fresh499 = c_246;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_247:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh501 = buffer;
            buffer = buffer.offset(1);
            *fresh501 = c_247;
            ...
            put_bits -= 8i32;
             let mut c_248:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh503 = buffer;
            buffer = buffer.offset(1);
            *fresh503 = c_248;
            ...
            put_bits -= 8i32;
             let mut c_249:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh505 = buffer;
            buffer = buffer.offset(1);
            *fresh505 = c_249;
            ...
            put_bits -= 8i32;
             let mut c_250:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh507 = buffer;
            buffer = buffer.offset(1);
            *fresh507 = c_250;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_251:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh509 = buffer;
                buffer = buffer.offset(1);
                *fresh509 = c_251;
                ...
                put_bits -= 8i32;
                 let mut c_252:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh511 = buffer;
                buffer = buffer.offset(1);
                *fresh511 = c_252;
                ...
                put_bits -= 8i32;
                 let mut c_253:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh513 = buffer;
                buffer = buffer.offset(1);
                *fresh513 = c_253;
                ...
                put_bits -= 8i32;
                 let mut c_254:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh515 = buffer;
                buffer = buffer.offset(1);
                *fresh515 = c_254;
                ...
                put_bits -= 8i32;
                 let mut c_255:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh517 = buffer;
                buffer = buffer.offset(1);
                *fresh517 = c_255;
                ...
                put_bits -= 8i32;
                 let mut c_256:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh519 = buffer;
                buffer = buffer.offset(1);
                *fresh519 = c_256;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_257:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh521 = buffer;
            buffer = buffer.offset(1);
            *fresh521 = c_257;
            ...
            put_bits -= 8i32;
             let mut c_258:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh523 = buffer;
            buffer = buffer.offset(1);
            *fresh523 = c_258;
            ...
            put_bits -= 8i32;
             let mut c_259:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh525 = buffer;
            buffer = buffer.offset(1);
            *fresh525 = c_259;
            ...
            put_bits -= 8i32;
             let mut c_260:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh527 = buffer;
            buffer = buffer.offset(1);
            *fresh527 = c_260;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_261:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh529 = buffer;
                buffer = buffer.offset(1);
                *fresh529 = c_261;
                ...
                put_bits -= 8i32;
                 let mut c_262:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh531 = buffer;
                buffer = buffer.offset(1);
                *fresh531 = c_262;
                ...
                put_bits -= 8i32;
                 let mut c_263:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh533 = buffer;
                buffer = buffer.offset(1);
                *fresh533 = c_263;
                ...
                put_bits -= 8i32;
                 let mut c_264:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh535 = buffer;
                buffer = buffer.offset(1);
                *fresh535 = c_264;
                ...
                put_bits -= 8i32;
                 let mut c_265:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh537 = buffer;
                buffer = buffer.offset(1);
                *fresh537 = c_265;
                ...
                put_bits -= 8i32;
                 let mut c_266:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh539 = buffer;
                buffer = buffer.offset(1);
                *fresh539 = c_266;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_267:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh541 = buffer;
            buffer = buffer.offset(1);
            *fresh541 = c_267;
            ...
            put_bits -= 8i32;
             let mut c_268:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh543 = buffer;
            buffer = buffer.offset(1);
            *fresh543 = c_268;
            ...
            put_bits -= 8i32;
             let mut c_269:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh545 = buffer;
            buffer = buffer.offset(1);
            *fresh545 = c_269;
            ...
            put_bits -= 8i32;
             let mut c_270:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh547 = buffer;
            buffer = buffer.offset(1);
            *fresh547 = c_270;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_271:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh549 = buffer;
                buffer = buffer.offset(1);
                *fresh549 = c_271;
                ...
                put_bits -= 8i32;
                 let mut c_272:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh551 = buffer;
                buffer = buffer.offset(1);
                *fresh551 = c_272;
                ...
                put_bits -= 8i32;
                 let mut c_273:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh553 = buffer;
                buffer = buffer.offset(1);
                *fresh553 = c_273;
                ...
                put_bits -= 8i32;
                 let mut c_274:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh555 = buffer;
                buffer = buffer.offset(1);
                *fresh555 = c_274;
                ...
                put_bits -= 8i32;
                 let mut c_275:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh557 = buffer;
                buffer = buffer.offset(1);
                *fresh557 = c_275;
                ...
                put_bits -= 8i32;
                 let mut c_276:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh559 = buffer;
                buffer = buffer.offset(1);
                *fresh559 = c_276;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_277:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh561 = buffer;
            buffer = buffer.offset(1);
            *fresh561 = c_277;
            ...
            put_bits -= 8i32;
             let mut c_278:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh563 = buffer;
            buffer = buffer.offset(1);
            *fresh563 = c_278;
            ...
            put_bits -= 8i32;
             let mut c_279:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh565 = buffer;
            buffer = buffer.offset(1);
            *fresh565 = c_279;
            ...
            put_bits -= 8i32;
             let mut c_280:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh567 = buffer;
            buffer = buffer.offset(1);
            *fresh567 = c_280;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_281:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh569 = buffer;
                buffer = buffer.offset(1);
                *fresh569 = c_281;
                ...
                put_bits -= 8i32;
                 let mut c_282:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh571 = buffer;
                buffer = buffer.offset(1);
                *fresh571 = c_282;
                ...
                put_bits -= 8i32;
                 let mut c_283:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh573 = buffer;
                buffer = buffer.offset(1);
                *fresh573 = c_283;
                ...
                put_bits -= 8i32;
                 let mut c_284:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh575 = buffer;
                buffer = buffer.offset(1);
                *fresh575 = c_284;
                ...
                put_bits -= 8i32;
                 let mut c_285:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh577 = buffer;
                buffer = buffer.offset(1);
                *fresh577 = c_285;
                ...
                put_bits -= 8i32;
                 let mut c_286:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh579 = buffer;
                buffer = buffer.offset(1);
                *fresh579 = c_286;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_287:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh581 = buffer;
            buffer = buffer.offset(1);
            *fresh581 = c_287;
            ...
            put_bits -= 8i32;
             let mut c_288:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh583 = buffer;
            buffer = buffer.offset(1);
            *fresh583 = c_288;
            ...
            put_bits -= 8i32;
             let mut c_289:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh585 = buffer;
            buffer = buffer.offset(1);
            *fresh585 = c_289;
            ...
            put_bits -= 8i32;
             let mut c_290:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh587 = buffer;
            buffer = buffer.offset(1);
            *fresh587 = c_290;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_291:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh589 = buffer;
                buffer = buffer.offset(1);
                *fresh589 = c_291;
                ...
                put_bits -= 8i32;
                 let mut c_292:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh591 = buffer;
                buffer = buffer.offset(1);
                *fresh591 = c_292;
                ...
                put_bits -= 8i32;
                 let mut c_293:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh593 = buffer;
                buffer = buffer.offset(1);
                *fresh593 = c_293;
                ...
                put_bits -= 8i32;
                 let mut c_294:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh595 = buffer;
                buffer = buffer.offset(1);
                *fresh595 = c_294;
                ...
                put_bits -= 8i32;
                 let mut c_295:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh597 = buffer;
                buffer = buffer.offset(1);
                *fresh597 = c_295;
                ...
                put_bits -= 8i32;
                 let mut c_296:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh599 = buffer;
                buffer = buffer.offset(1);
                *fresh599 = c_296;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_297:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh601 = buffer;
            buffer = buffer.offset(1);
            *fresh601 = c_297;
            ...
            put_bits -= 8i32;
             let mut c_298:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh603 = buffer;
            buffer = buffer.offset(1);
            *fresh603 = c_298;
            ...
            put_bits -= 8i32;
             let mut c_299:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh605 = buffer;
            buffer = buffer.offset(1);
            *fresh605 = c_299;
            ...
            put_bits -= 8i32;
             let mut c_300:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh607 = buffer;
            buffer = buffer.offset(1);
            *fresh607 = c_300;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_301:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh609 = buffer;
                buffer = buffer.offset(1);
                *fresh609 = c_301;
                ...
                put_bits -= 8i32;
                 let mut c_302:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh611 = buffer;
                buffer = buffer.offset(1);
                *fresh611 = c_302;
                ...
                put_bits -= 8i32;
                 let mut c_303:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh613 = buffer;
                buffer = buffer.offset(1);
                *fresh613 = c_303;
                ...
                put_bits -= 8i32;
                 let mut c_304:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh615 = buffer;
                buffer = buffer.offset(1);
                *fresh615 = c_304;
                ...
                put_bits -= 8i32;
                 let mut c_305:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh617 = buffer;
                buffer = buffer.offset(1);
                *fresh617 = c_305;
                ...
                put_bits -= 8i32;
                 let mut c_306:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh619 = buffer;
                buffer = buffer.offset(1);
                *fresh619 = c_306;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_307:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh621 = buffer;
            buffer = buffer.offset(1);
            *fresh621 = c_307;
            ...
            put_bits -= 8i32;
             let mut c_308:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh623 = buffer;
            buffer = buffer.offset(1);
            *fresh623 = c_308;
            ...
            put_bits -= 8i32;
             let mut c_309:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh625 = buffer;
            buffer = buffer.offset(1);
            *fresh625 = c_309;
            ...
            put_bits -= 8i32;
             let mut c_310:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh627 = buffer;
            buffer = buffer.offset(1);
            *fresh627 = c_310;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_311:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh629 = buffer;
                buffer = buffer.offset(1);
                *fresh629 = c_311;
                ...
                put_bits -= 8i32;
                 let mut c_312:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh631 = buffer;
                buffer = buffer.offset(1);
                *fresh631 = c_312;
                ...
                put_bits -= 8i32;
                 let mut c_313:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh633 = buffer;
                buffer = buffer.offset(1);
                *fresh633 = c_313;
                ...
                put_bits -= 8i32;
                 let mut c_314:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh635 = buffer;
                buffer = buffer.offset(1);
                *fresh635 = c_314;
                ...
                put_bits -= 8i32;
                 let mut c_315:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh637 = buffer;
                buffer = buffer.offset(1);
                *fresh637 = c_315;
                ...
                put_bits -= 8i32;
                 let mut c_316:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh639 = buffer;
                buffer = buffer.offset(1);
                *fresh639 = c_316;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_317:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh641 = buffer;
            buffer = buffer.offset(1);
            *fresh641 = c_317;
            ...
            put_bits -= 8i32;
             let mut c_318:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh643 = buffer;
            buffer = buffer.offset(1);
            *fresh643 = c_318;
            ...
            put_bits -= 8i32;
             let mut c_319:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh645 = buffer;
            buffer = buffer.offset(1);
            *fresh645 = c_319;
            ...
            put_bits -= 8i32;
             let mut c_320:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh647 = buffer;
            buffer = buffer.offset(1);
            *fresh647 = c_320;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_321:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh649 = buffer;
                buffer = buffer.offset(1);
                *fresh649 = c_321;
                ...
                put_bits -= 8i32;
                 let mut c_322:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh651 = buffer;
                buffer = buffer.offset(1);
                *fresh651 = c_322;
                ...
                put_bits -= 8i32;
                 let mut c_323:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh653 = buffer;
                buffer = buffer.offset(1);
                *fresh653 = c_323;
                ...
                put_bits -= 8i32;
                 let mut c_324:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh655 = buffer;
                buffer = buffer.offset(1);
                *fresh655 = c_324;
                ...
                put_bits -= 8i32;
                 let mut c_325:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh657 = buffer;
                buffer = buffer.offset(1);
                *fresh657 = c_325;
                ...
                put_bits -= 8i32;
                 let mut c_326:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh659 = buffer;
                buffer = buffer.offset(1);
                *fresh659 = c_326;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_327:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh661 = buffer;
            buffer = buffer.offset(1);
            *fresh661 = c_327;
            ...
            put_bits -= 8i32;
             let mut c_328:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh663 = buffer;
            buffer = buffer.offset(1);
            *fresh663 = c_328;
            ...
            put_bits -= 8i32;
             let mut c_329:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh665 = buffer;
            buffer = buffer.offset(1);
            *fresh665 = c_329;
            ...
            put_bits -= 8i32;
             let mut c_330:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh667 = buffer;
            buffer = buffer.offset(1);
            *fresh667 = c_330;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_331:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh669 = buffer;
                buffer = buffer.offset(1);
                *fresh669 = c_331;
                ...
                put_bits -= 8i32;
                 let mut c_332:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh671 = buffer;
                buffer = buffer.offset(1);
                *fresh671 = c_332;
                ...
                put_bits -= 8i32;
                 let mut c_333:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh673 = buffer;
                buffer = buffer.offset(1);
                *fresh673 = c_333;
                ...
                put_bits -= 8i32;
                 let mut c_334:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh675 = buffer;
                buffer = buffer.offset(1);
                *fresh675 = c_334;
                ...
                put_bits -= 8i32;
                 let mut c_335:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh677 = buffer;
                buffer = buffer.offset(1);
                *fresh677 = c_335;
                ...
                put_bits -= 8i32;
                 let mut c_336:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh679 = buffer;
                buffer = buffer.offset(1);
                *fresh679 = c_336;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_337:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh681 = buffer;
            buffer = buffer.offset(1);
            *fresh681 = c_337;
            ...
            put_bits -= 8i32;
             let mut c_338:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh683 = buffer;
            buffer = buffer.offset(1);
            *fresh683 = c_338;
            ...
            put_bits -= 8i32;
             let mut c_339:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh685 = buffer;
            buffer = buffer.offset(1);
            *fresh685 = c_339;
            ...
            put_bits -= 8i32;
             let mut c_340:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh687 = buffer;
            buffer = buffer.offset(1);
            *fresh687 = c_340;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_341:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh689 = buffer;
                buffer = buffer.offset(1);
                *fresh689 = c_341;
                ...
                put_bits -= 8i32;
                 let mut c_342:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh691 = buffer;
                buffer = buffer.offset(1);
                *fresh691 = c_342;
                ...
                put_bits -= 8i32;
                 let mut c_343:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh693 = buffer;
                buffer = buffer.offset(1);
                *fresh693 = c_343;
                ...
                put_bits -= 8i32;
                 let mut c_344:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh695 = buffer;
                buffer = buffer.offset(1);
                *fresh695 = c_344;
                ...
                put_bits -= 8i32;
                 let mut c_345:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh697 = buffer;
                buffer = buffer.offset(1);
                *fresh697 = c_345;
                ...
                put_bits -= 8i32;
                 let mut c_346:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh699 = buffer;
                buffer = buffer.offset(1);
                *fresh699 = c_346;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_347:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh701 = buffer;
            buffer = buffer.offset(1);
            *fresh701 = c_347;
            ...
            put_bits -= 8i32;
             let mut c_348:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh703 = buffer;
            buffer = buffer.offset(1);
            *fresh703 = c_348;
            ...
            put_bits -= 8i32;
             let mut c_349:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh705 = buffer;
            buffer = buffer.offset(1);
            *fresh705 = c_349;
            ...
            put_bits -= 8i32;
             let mut c_350:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh707 = buffer;
            buffer = buffer.offset(1);
            *fresh707 = c_350;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_351:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh709 = buffer;
                buffer = buffer.offset(1);
                *fresh709 = c_351;
                ...
                put_bits -= 8i32;
                 let mut c_352:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh711 = buffer;
                buffer = buffer.offset(1);
                *fresh711 = c_352;
                ...
                put_bits -= 8i32;
                 let mut c_353:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh713 = buffer;
                buffer = buffer.offset(1);
                *fresh713 = c_353;
                ...
                put_bits -= 8i32;
                 let mut c_354:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh715 = buffer;
                buffer = buffer.offset(1);
                *fresh715 = c_354;
                ...
                put_bits -= 8i32;
                 let mut c_355:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh717 = buffer;
                buffer = buffer.offset(1);
                *fresh717 = c_355;
                ...
                put_bits -= 8i32;
                 let mut c_356:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh719 = buffer;
                buffer = buffer.offset(1);
                *fresh719 = c_356;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_357:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh721 = buffer;
            buffer = buffer.offset(1);
            *fresh721 = c_357;
            ...
            put_bits -= 8i32;
             let mut c_358:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh723 = buffer;
            buffer = buffer.offset(1);
            *fresh723 = c_358;
            ...
            put_bits -= 8i32;
             let mut c_359:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh725 = buffer;
            buffer = buffer.offset(1);
            *fresh725 = c_359;
            ...
            put_bits -= 8i32;
             let mut c_360:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh727 = buffer;
            buffer = buffer.offset(1);
            *fresh727 = c_360;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_361:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh729 = buffer;
                buffer = buffer.offset(1);
                *fresh729 = c_361;
                ...
                put_bits -= 8i32;
                 let mut c_362:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh731 = buffer;
                buffer = buffer.offset(1);
                *fresh731 = c_362;
                ...
                put_bits -= 8i32;
                 let mut c_363:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh733 = buffer;
                buffer = buffer.offset(1);
                *fresh733 = c_363;
                ...
                put_bits -= 8i32;
                 let mut c_364:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh735 = buffer;
                buffer = buffer.offset(1);
                *fresh735 = c_364;
                ...
                put_bits -= 8i32;
                 let mut c_365:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh737 = buffer;
                buffer = buffer.offset(1);
                *fresh737 = c_365;
                ...
                put_bits -= 8i32;
                 let mut c_366:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh739 = buffer;
                buffer = buffer.offset(1);
                *fresh739 = c_366;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_367:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh741 = buffer;
            buffer = buffer.offset(1);
            *fresh741 = c_367;
            ...
            put_bits -= 8i32;
             let mut c_368:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh743 = buffer;
            buffer = buffer.offset(1);
            *fresh743 = c_368;
            ...
            put_bits -= 8i32;
             let mut c_369:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh745 = buffer;
            buffer = buffer.offset(1);
            *fresh745 = c_369;
            ...
            put_bits -= 8i32;
             let mut c_370:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh747 = buffer;
            buffer = buffer.offset(1);
            *fresh747 = c_370;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_371:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh749 = buffer;
                buffer = buffer.offset(1);
                *fresh749 = c_371;
                ...
                put_bits -= 8i32;
                 let mut c_372:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh751 = buffer;
                buffer = buffer.offset(1);
                *fresh751 = c_372;
                ...
                put_bits -= 8i32;
                 let mut c_373:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh753 = buffer;
                buffer = buffer.offset(1);
                *fresh753 = c_373;
                ...
                put_bits -= 8i32;
                 let mut c_374:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh755 = buffer;
                buffer = buffer.offset(1);
                *fresh755 = c_374;
                ...
                put_bits -= 8i32;
                 let mut c_375:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh757 = buffer;
                buffer = buffer.offset(1);
                *fresh757 = c_375;
                ...
                put_bits -= 8i32;
                 let mut c_376:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh759 = buffer;
                buffer = buffer.offset(1);
                *fresh759 = c_376;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_377:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh761 = buffer;
            buffer = buffer.offset(1);
            *fresh761 = c_377;
            ...
            put_bits -= 8i32;
             let mut c_378:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh763 = buffer;
            buffer = buffer.offset(1);
            *fresh763 = c_378;
            ...
            put_bits -= 8i32;
             let mut c_379:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh765 = buffer;
            buffer = buffer.offset(1);
            *fresh765 = c_379;
            ...
            put_bits -= 8i32;
             let mut c_380:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh767 = buffer;
            buffer = buffer.offset(1);
            *fresh767 = c_380;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_381:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh769 = buffer;
                buffer = buffer.offset(1);
                *fresh769 = c_381;
                ...
                put_bits -= 8i32;
                 let mut c_382:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh771 = buffer;
                buffer = buffer.offset(1);
                *fresh771 = c_382;
                ...
                put_bits -= 8i32;
                 let mut c_383:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh773 = buffer;
                buffer = buffer.offset(1);
                *fresh773 = c_383;
                ...
                put_bits -= 8i32;
                 let mut c_384:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh775 = buffer;
                buffer = buffer.offset(1);
                *fresh775 = c_384;
                ...
                put_bits -= 8i32;
                 let mut c_385:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh777 = buffer;
                buffer = buffer.offset(1);
                *fresh777 = c_385;
                ...
                put_bits -= 8i32;
                 let mut c_386:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh779 = buffer;
                buffer = buffer.offset(1);
                *fresh779 = c_386;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_387:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh781 = buffer;
            buffer = buffer.offset(1);
            *fresh781 = c_387;
            ...
            put_bits -= 8i32;
             let mut c_388:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh783 = buffer;
            buffer = buffer.offset(1);
            *fresh783 = c_388;
            ...
            put_bits -= 8i32;
             let mut c_389:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh785 = buffer;
            buffer = buffer.offset(1);
            *fresh785 = c_389;
            ...
            put_bits -= 8i32;
             let mut c_390:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh787 = buffer;
            buffer = buffer.offset(1);
            *fresh787 = c_390;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_391:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh789 = buffer;
                buffer = buffer.offset(1);
                *fresh789 = c_391;
                ...
                put_bits -= 8i32;
                 let mut c_392:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh791 = buffer;
                buffer = buffer.offset(1);
                *fresh791 = c_392;
                ...
                put_bits -= 8i32;
                 let mut c_393:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh793 = buffer;
                buffer = buffer.offset(1);
                *fresh793 = c_393;
                ...
                put_bits -= 8i32;
                 let mut c_394:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh795 = buffer;
                buffer = buffer.offset(1);
                *fresh795 = c_394;
                ...
                put_bits -= 8i32;
                 let mut c_395:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh797 = buffer;
                buffer = buffer.offset(1);
                *fresh797 = c_395;
                ...
                put_bits -= 8i32;
                 let mut c_396:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh799 = buffer;
                buffer = buffer.offset(1);
                *fresh799 = c_396;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_397:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh801 = buffer;
            buffer = buffer.offset(1);
            *fresh801 = c_397;
            ...
            put_bits -= 8i32;
             let mut c_398:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh803 = buffer;
            buffer = buffer.offset(1);
            *fresh803 = c_398;
            ...
            put_bits -= 8i32;
             let mut c_399:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh805 = buffer;
            buffer = buffer.offset(1);
            *fresh805 = c_399;
            ...
            put_bits -= 8i32;
             let mut c_400:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh807 = buffer;
            buffer = buffer.offset(1);
            *fresh807 = c_400;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_401:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh809 = buffer;
                buffer = buffer.offset(1);
                *fresh809 = c_401;
                ...
                put_bits -= 8i32;
                 let mut c_402:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh811 = buffer;
                buffer = buffer.offset(1);
                *fresh811 = c_402;
                ...
                put_bits -= 8i32;
                 let mut c_403:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh813 = buffer;
                buffer = buffer.offset(1);
                *fresh813 = c_403;
                ...
                put_bits -= 8i32;
                 let mut c_404:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh815 = buffer;
                buffer = buffer.offset(1);
                *fresh815 = c_404;
                ...
                put_bits -= 8i32;
                 let mut c_405:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh817 = buffer;
                buffer = buffer.offset(1);
                *fresh817 = c_405;
                ...
                put_bits -= 8i32;
                 let mut c_406:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh819 = buffer;
                buffer = buffer.offset(1);
                *fresh819 = c_406;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_407:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh821 = buffer;
            buffer = buffer.offset(1);
            *fresh821 = c_407;
            ...
            put_bits -= 8i32;
             let mut c_408:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh823 = buffer;
            buffer = buffer.offset(1);
            *fresh823 = c_408;
            ...
            put_bits -= 8i32;
             let mut c_409:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh825 = buffer;
            buffer = buffer.offset(1);
            *fresh825 = c_409;
            ...
            put_bits -= 8i32;
             let mut c_410:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh827 = buffer;
            buffer = buffer.offset(1);
            *fresh827 = c_410;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_411:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh829 = buffer;
                buffer = buffer.offset(1);
                *fresh829 = c_411;
                ...
                put_bits -= 8i32;
                 let mut c_412:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh831 = buffer;
                buffer = buffer.offset(1);
                *fresh831 = c_412;
                ...
                put_bits -= 8i32;
                 let mut c_413:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh833 = buffer;
                buffer = buffer.offset(1);
                *fresh833 = c_413;
                ...
                put_bits -= 8i32;
                 let mut c_414:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh835 = buffer;
                buffer = buffer.offset(1);
                *fresh835 = c_414;
                ...
                put_bits -= 8i32;
                 let mut c_415:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh837 = buffer;
                buffer = buffer.offset(1);
                *fresh837 = c_415;
                ...
                put_bits -= 8i32;
                 let mut c_416:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh839 = buffer;
                buffer = buffer.offset(1);
                *fresh839 = c_416;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_417:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh841 = buffer;
            buffer = buffer.offset(1);
            *fresh841 = c_417;
            ...
            put_bits -= 8i32;
             let mut c_418:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh843 = buffer;
            buffer = buffer.offset(1);
            *fresh843 = c_418;
            ...
            put_bits -= 8i32;
             let mut c_419:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh845 = buffer;
            buffer = buffer.offset(1);
            *fresh845 = c_419;
            ...
            put_bits -= 8i32;
             let mut c_420:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh847 = buffer;
            buffer = buffer.offset(1);
            *fresh847 = c_420;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_421:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh849 = buffer;
                buffer = buffer.offset(1);
                *fresh849 = c_421;
                ...
                put_bits -= 8i32;
                 let mut c_422:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh851 = buffer;
                buffer = buffer.offset(1);
                *fresh851 = c_422;
                ...
                put_bits -= 8i32;
                 let mut c_423:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh853 = buffer;
                buffer = buffer.offset(1);
                *fresh853 = c_423;
                ...
                put_bits -= 8i32;
                 let mut c_424:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh855 = buffer;
                buffer = buffer.offset(1);
                *fresh855 = c_424;
                ...
                put_bits -= 8i32;
                 let mut c_425:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh857 = buffer;
                buffer = buffer.offset(1);
                *fresh857 = c_425;
                ...
                put_bits -= 8i32;
                 let mut c_426:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh859 = buffer;
                buffer = buffer.offset(1);
                *fresh859 = c_426;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_427:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh861 = buffer;
            buffer = buffer.offset(1);
            *fresh861 = c_427;
            ...
            put_bits -= 8i32;
             let mut c_428:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh863 = buffer;
            buffer = buffer.offset(1);
            *fresh863 = c_428;
            ...
            put_bits -= 8i32;
             let mut c_429:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh865 = buffer;
            buffer = buffer.offset(1);
            *fresh865 = c_429;
            ...
            put_bits -= 8i32;
             let mut c_430:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh867 = buffer;
            buffer = buffer.offset(1);
            *fresh867 = c_430;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_431:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh869 = buffer;
                buffer = buffer.offset(1);
                *fresh869 = c_431;
                ...
                put_bits -= 8i32;
                 let mut c_432:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh871 = buffer;
                buffer = buffer.offset(1);
                *fresh871 = c_432;
                ...
                put_bits -= 8i32;
                 let mut c_433:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh873 = buffer;
                buffer = buffer.offset(1);
                *fresh873 = c_433;
                ...
                put_bits -= 8i32;
                 let mut c_434:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh875 = buffer;
                buffer = buffer.offset(1);
                *fresh875 = c_434;
                ...
                put_bits -= 8i32;
                 let mut c_435:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh877 = buffer;
                buffer = buffer.offset(1);
                *fresh877 = c_435;
                ...
                put_bits -= 8i32;
                 let mut c_436:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh879 = buffer;
                buffer = buffer.offset(1);
                *fresh879 = c_436;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_437:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh881 = buffer;
            buffer = buffer.offset(1);
            *fresh881 = c_437;
            ...
            put_bits -= 8i32;
             let mut c_438:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh883 = buffer;
            buffer = buffer.offset(1);
            *fresh883 = c_438;
            ...
            put_bits -= 8i32;
             let mut c_439:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh885 = buffer;
            buffer = buffer.offset(1);
            *fresh885 = c_439;
            ...
            put_bits -= 8i32;
             let mut c_440:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh887 = buffer;
            buffer = buffer.offset(1);
            *fresh887 = c_440;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_441:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh889 = buffer;
                buffer = buffer.offset(1);
                *fresh889 = c_441;
                ...
                put_bits -= 8i32;
                 let mut c_442:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh891 = buffer;
                buffer = buffer.offset(1);
                *fresh891 = c_442;
                ...
                put_bits -= 8i32;
                 let mut c_443:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh893 = buffer;
                buffer = buffer.offset(1);
                *fresh893 = c_443;
                ...
                put_bits -= 8i32;
                 let mut c_444:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh895 = buffer;
                buffer = buffer.offset(1);
                *fresh895 = c_444;
                ...
                put_bits -= 8i32;
                 let mut c_445:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh897 = buffer;
                buffer = buffer.offset(1);
                *fresh897 = c_445;
                ...
                put_bits -= 8i32;
                 let mut c_446:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh899 = buffer;
                buffer = buffer.offset(1);
                *fresh899 = c_446;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_447:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh901 = buffer;
            buffer = buffer.offset(1);
            *fresh901 = c_447;
            ...
            put_bits -= 8i32;
             let mut c_448:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh903 = buffer;
            buffer = buffer.offset(1);
            *fresh903 = c_448;
            ...
            put_bits -= 8i32;
             let mut c_449:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh905 = buffer;
            buffer = buffer.offset(1);
            *fresh905 = c_449;
            ...
            put_bits -= 8i32;
             let mut c_450:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh907 = buffer;
            buffer = buffer.offset(1);
            *fresh907 = c_450;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_451:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh909 = buffer;
                buffer = buffer.offset(1);
                *fresh909 = c_451;
                ...
                put_bits -= 8i32;
                 let mut c_452:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh911 = buffer;
                buffer = buffer.offset(1);
                *fresh911 = c_452;
                ...
                put_bits -= 8i32;
                 let mut c_453:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh913 = buffer;
                buffer = buffer.offset(1);
                *fresh913 = c_453;
                ...
                put_bits -= 8i32;
                 let mut c_454:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh915 = buffer;
                buffer = buffer.offset(1);
                *fresh915 = c_454;
                ...
                put_bits -= 8i32;
                 let mut c_455:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh917 = buffer;
                buffer = buffer.offset(1);
                *fresh917 = c_455;
                ...
                put_bits -= 8i32;
                 let mut c_456:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh919 = buffer;
                buffer = buffer.offset(1);
                *fresh919 = c_456;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_457:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh921 = buffer;
            buffer = buffer.offset(1);
            *fresh921 = c_457;
            ...
            put_bits -= 8i32;
             let mut c_458:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh923 = buffer;
            buffer = buffer.offset(1);
            *fresh923 = c_458;
            ...
            put_bits -= 8i32;
             let mut c_459:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh925 = buffer;
            buffer = buffer.offset(1);
            *fresh925 = c_459;
            ...
            put_bits -= 8i32;
             let mut c_460:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh927 = buffer;
            buffer = buffer.offset(1);
            *fresh927 = c_460;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_461:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh929 = buffer;
                buffer = buffer.offset(1);
                *fresh929 = c_461;
                ...
                put_bits -= 8i32;
                 let mut c_462:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh931 = buffer;
                buffer = buffer.offset(1);
                *fresh931 = c_462;
                ...
                put_bits -= 8i32;
                 let mut c_463:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh933 = buffer;
                buffer = buffer.offset(1);
                *fresh933 = c_463;
                ...
                put_bits -= 8i32;
                 let mut c_464:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh935 = buffer;
                buffer = buffer.offset(1);
                *fresh935 = c_464;
                ...
                put_bits -= 8i32;
                 let mut c_465:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh937 = buffer;
                buffer = buffer.offset(1);
                *fresh937 = c_465;
                ...
                put_bits -= 8i32;
                 let mut c_466:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh939 = buffer;
                buffer = buffer.offset(1);
                *fresh939 = c_466;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_467:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh941 = buffer;
            buffer = buffer.offset(1);
            *fresh941 = c_467;
            ...
            put_bits -= 8i32;
             let mut c_468:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh943 = buffer;
            buffer = buffer.offset(1);
            *fresh943 = c_468;
            ...
            put_bits -= 8i32;
             let mut c_469:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh945 = buffer;
            buffer = buffer.offset(1);
            *fresh945 = c_469;
            ...
            put_bits -= 8i32;
             let mut c_470:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh947 = buffer;
            buffer = buffer.offset(1);
            *fresh947 = c_470;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_471:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh949 = buffer;
                buffer = buffer.offset(1);
                *fresh949 = c_471;
                ...
                put_bits -= 8i32;
                 let mut c_472:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh951 = buffer;
                buffer = buffer.offset(1);
                *fresh951 = c_472;
                ...
                put_bits -= 8i32;
                 let mut c_473:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh953 = buffer;
                buffer = buffer.offset(1);
                *fresh953 = c_473;
                ...
                put_bits -= 8i32;
                 let mut c_474:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh955 = buffer;
                buffer = buffer.offset(1);
                *fresh955 = c_474;
                ...
                put_bits -= 8i32;
                 let mut c_475:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh957 = buffer;
                buffer = buffer.offset(1);
                *fresh957 = c_475;
                ...
                put_bits -= 8i32;
                 let mut c_476:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh959 = buffer;
                buffer = buffer.offset(1);
                *fresh959 = c_476;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_477:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh961 = buffer;
            buffer = buffer.offset(1);
            *fresh961 = c_477;
            ...
            put_bits -= 8i32;
             let mut c_478:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh963 = buffer;
            buffer = buffer.offset(1);
            *fresh963 = c_478;
            ...
            put_bits -= 8i32;
             let mut c_479:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh965 = buffer;
            buffer = buffer.offset(1);
            *fresh965 = c_479;
            ...
            put_bits -= 8i32;
             let mut c_480:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh967 = buffer;
            buffer = buffer.offset(1);
            *fresh967 = c_480;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_481:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh969 = buffer;
                buffer = buffer.offset(1);
                *fresh969 = c_481;
                ...
                put_bits -= 8i32;
                 let mut c_482:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh971 = buffer;
                buffer = buffer.offset(1);
                *fresh971 = c_482;
                ...
                put_bits -= 8i32;
                 let mut c_483:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh973 = buffer;
                buffer = buffer.offset(1);
                *fresh973 = c_483;
                ...
                put_bits -= 8i32;
                 let mut c_484:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh975 = buffer;
                buffer = buffer.offset(1);
                *fresh975 = c_484;
                ...
                put_bits -= 8i32;
                 let mut c_485:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh977 = buffer;
                buffer = buffer.offset(1);
                *fresh977 = c_485;
                ...
                put_bits -= 8i32;
                 let mut c_486:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh979 = buffer;
                buffer = buffer.offset(1);
                *fresh979 = c_486;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_487:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh981 = buffer;
            buffer = buffer.offset(1);
            *fresh981 = c_487;
            ...
            put_bits -= 8i32;
             let mut c_488:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh983 = buffer;
            buffer = buffer.offset(1);
            *fresh983 = c_488;
            ...
            put_bits -= 8i32;
             let mut c_489:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh985 = buffer;
            buffer = buffer.offset(1);
            *fresh985 = c_489;
            ...
            put_bits -= 8i32;
             let mut c_490:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            let fresh987 = buffer;
            buffer = buffer.offset(1);
            *fresh987 = c_490;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_491:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh989 = buffer;
                buffer = buffer.offset(1);
                *fresh989 = c_491;
                ...
                put_bits -= 8i32;
                 let mut c_492:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh991 = buffer;
                buffer = buffer.offset(1);
                *fresh991 = c_492;
                ...
                put_bits -= 8i32;
                 let mut c_493:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh993 = buffer;
                buffer = buffer.offset(1);
                *fresh993 = c_493;
                ...
                put_bits -= 8i32;
                 let mut c_494:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh995 = buffer;
                buffer = buffer.offset(1);
                *fresh995 = c_494;
                ...
                put_bits -= 8i32;
                 let mut c_495:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh997 = buffer;
                buffer = buffer.offset(1);
                *fresh997 = c_495;
                ...
                put_bits -= 8i32;
                 let mut c_496:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                let fresh999 = buffer;
                buffer = buffer.offset(1);
                *fresh999 = c_496;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_497:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1001 = c_497;
            ...
            put_bits -= 8i32;
             let mut c_498:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1003 = c_498;
            ...
            put_bits -= 8i32;
             let mut c_499:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1005 = c_499;
            ...
            put_bits -= 8i32;
             let mut c_500:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_501:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1009 = c_501;
                ...
                put_bits -= 8i32;
                 let mut c_502:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1011 = c_502;
                ...
                put_bits -= 8i32;
                 let mut c_503:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1013 = c_503;
                ...
                put_bits -= 8i32;
                 let mut c_504:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1015 = c_504;
                ...
                put_bits -= 8i32;
                 let mut c_505:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1017 = c_505;
                ...
                put_bits -= 8i32;
                 let mut c_506:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_507:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1021 = c_507;
            ...
            put_bits -= 8i32;
             let mut c_508:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1023 = c_508;
            ...
            put_bits -= 8i32;
             let mut c_509:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1025 = c_509;
            ...
            put_bits -= 8i32;
             let mut c_510:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_511:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1029 = c_511;
                ...
                put_bits -= 8i32;
                 let mut c_512:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1031 = c_512;
                ...
                put_bits -= 8i32;
                 let mut c_513:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1033 = c_513;
                ...
                put_bits -= 8i32;
                 let mut c_514:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1035 = c_514;
                ...
                put_bits -= 8i32;
                 let mut c_515:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1037 = c_515;
                ...
                put_bits -= 8i32;
                 let mut c_516:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_517:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1041 = c_517;
            ...
            put_bits -= 8i32;
             let mut c_518:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1043 = c_518;
            ...
            put_bits -= 8i32;
             let mut c_519:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1045 = c_519;
            ...
            put_bits -= 8i32;
             let mut c_520:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_521:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1049 = c_521;
                ...
                put_bits -= 8i32;
                 let mut c_522:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1051 = c_522;
                ...
                put_bits -= 8i32;
                 let mut c_523:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1053 = c_523;
                ...
                put_bits -= 8i32;
                 let mut c_524:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1055 = c_524;
                ...
                put_bits -= 8i32;
                 let mut c_525:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1057 = c_525;
                ...
                put_bits -= 8i32;
                 let mut c_526:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_527:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1061 = c_527;
            ...
            put_bits -= 8i32;
             let mut c_528:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1063 = c_528;
            ...
            put_bits -= 8i32;
             let mut c_529:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1065 = c_529;
            ...
            put_bits -= 8i32;
             let mut c_530:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_531:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1069 = c_531;
                ...
                put_bits -= 8i32;
                 let mut c_532:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1071 = c_532;
                ...
                put_bits -= 8i32;
                 let mut c_533:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1073 = c_533;
                ...
                put_bits -= 8i32;
                 let mut c_534:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1075 = c_534;
                ...
                put_bits -= 8i32;
                 let mut c_535:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1077 = c_535;
                ...
                put_bits -= 8i32;
                 let mut c_536:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_537:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1081 = c_537;
            ...
            put_bits -= 8i32;
             let mut c_538:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1083 = c_538;
            ...
            put_bits -= 8i32;
             let mut c_539:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1085 = c_539;
            ...
            put_bits -= 8i32;
             let mut c_540:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_541:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1089 = c_541;
                ...
                put_bits -= 8i32;
                 let mut c_542:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1091 = c_542;
                ...
                put_bits -= 8i32;
                 let mut c_543:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1093 = c_543;
                ...
                put_bits -= 8i32;
                 let mut c_544:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1095 = c_544;
                ...
                put_bits -= 8i32;
                 let mut c_545:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1097 = c_545;
                ...
                put_bits -= 8i32;
                 let mut c_546:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_547:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1101 = c_547;
            ...
            put_bits -= 8i32;
             let mut c_548:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1103 = c_548;
            ...
            put_bits -= 8i32;
             let mut c_549:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1105 = c_549;
            ...
            put_bits -= 8i32;
             let mut c_550:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_551:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1109 = c_551;
                ...
                put_bits -= 8i32;
                 let mut c_552:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1111 = c_552;
                ...
                put_bits -= 8i32;
                 let mut c_553:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1113 = c_553;
                ...
                put_bits -= 8i32;
                 let mut c_554:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1115 = c_554;
                ...
                put_bits -= 8i32;
                 let mut c_555:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1117 = c_555;
                ...
                put_bits -= 8i32;
                 let mut c_556:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_557:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1121 = c_557;
            ...
            put_bits -= 8i32;
             let mut c_558:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1123 = c_558;
            ...
            put_bits -= 8i32;
             let mut c_559:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1125 = c_559;
            ...
            put_bits -= 8i32;
             let mut c_560:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_561:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1129 = c_561;
                ...
                put_bits -= 8i32;
                 let mut c_562:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1131 = c_562;
                ...
                put_bits -= 8i32;
                 let mut c_563:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1133 = c_563;
                ...
                put_bits -= 8i32;
                 let mut c_564:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1135 = c_564;
                ...
                put_bits -= 8i32;
                 let mut c_565:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1137 = c_565;
                ...
                put_bits -= 8i32;
                 let mut c_566:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_567:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1141 = c_567;
            ...
            put_bits -= 8i32;
             let mut c_568:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1143 = c_568;
            ...
            put_bits -= 8i32;
             let mut c_569:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1145 = c_569;
            ...
            put_bits -= 8i32;
             let mut c_570:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_571:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1149 = c_571;
                ...
                put_bits -= 8i32;
                 let mut c_572:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1151 = c_572;
                ...
                put_bits -= 8i32;
                 let mut c_573:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1153 = c_573;
                ...
                put_bits -= 8i32;
                 let mut c_574:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1155 = c_574;
                ...
                put_bits -= 8i32;
                 let mut c_575:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1157 = c_575;
                ...
                put_bits -= 8i32;
                 let mut c_576:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_577:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1161 = c_577;
            ...
            put_bits -= 8i32;
             let mut c_578:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1163 = c_578;
            ...
            put_bits -= 8i32;
             let mut c_579:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1165 = c_579;
            ...
            put_bits -= 8i32;
             let mut c_580:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_581:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1169 = c_581;
                ...
                put_bits -= 8i32;
                 let mut c_582:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1171 = c_582;
                ...
                put_bits -= 8i32;
                 let mut c_583:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1173 = c_583;
                ...
                put_bits -= 8i32;
                 let mut c_584:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1175 = c_584;
                ...
                put_bits -= 8i32;
                 let mut c_585:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1177 = c_585;
                ...
                put_bits -= 8i32;
                 let mut c_586:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_587:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1181 = c_587;
            ...
            put_bits -= 8i32;
             let mut c_588:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1183 = c_588;
            ...
            put_bits -= 8i32;
             let mut c_589:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1185 = c_589;
            ...
            put_bits -= 8i32;
             let mut c_590:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_591:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1189 = c_591;
                ...
                put_bits -= 8i32;
                 let mut c_592:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1191 = c_592;
                ...
                put_bits -= 8i32;
                 let mut c_593:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1193 = c_593;
                ...
                put_bits -= 8i32;
                 let mut c_594:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1195 = c_594;
                ...
                put_bits -= 8i32;
                 let mut c_595:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1197 = c_595;
                ...
                put_bits -= 8i32;
                 let mut c_596:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_597:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1201 = c_597;
            ...
            put_bits -= 8i32;
             let mut c_598:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1203 = c_598;
            ...
            put_bits -= 8i32;
             let mut c_599:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1205 = c_599;
            ...
            put_bits -= 8i32;
             let mut c_600:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_601:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1209 = c_601;
                ...
                put_bits -= 8i32;
                 let mut c_602:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1211 = c_602;
                ...
                put_bits -= 8i32;
                 let mut c_603:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1213 = c_603;
                ...
                put_bits -= 8i32;
                 let mut c_604:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1215 = c_604;
                ...
                put_bits -= 8i32;
                 let mut c_605:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1217 = c_605;
                ...
                put_bits -= 8i32;
                 let mut c_606:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_607:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1221 = c_607;
            ...
            put_bits -= 8i32;
             let mut c_608:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1223 = c_608;
            ...
            put_bits -= 8i32;
             let mut c_609:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1225 = c_609;
            ...
            put_bits -= 8i32;
             let mut c_610:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_611:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1229 = c_611;
                ...
                put_bits -= 8i32;
                 let mut c_612:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1231 = c_612;
                ...
                put_bits -= 8i32;
                 let mut c_613:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1233 = c_613;
                ...
                put_bits -= 8i32;
                 let mut c_614:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1235 = c_614;
                ...
                put_bits -= 8i32;
                 let mut c_615:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1237 = c_615;
                ...
                put_bits -= 8i32;
                 let mut c_616:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_617:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1241 = c_617;
            ...
            put_bits -= 8i32;
             let mut c_618:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1243 = c_618;
            ...
            put_bits -= 8i32;
             let mut c_619:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1245 = c_619;
            ...
            put_bits -= 8i32;
             let mut c_620:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_621:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1249 = c_621;
                ...
                put_bits -= 8i32;
                 let mut c_622:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1251 = c_622;
                ...
                put_bits -= 8i32;
                 let mut c_623:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1253 = c_623;
                ...
                put_bits -= 8i32;
                 let mut c_624:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1255 = c_624;
                ...
                put_bits -= 8i32;
                 let mut c_625:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1257 = c_625;
                ...
                put_bits -= 8i32;
                 let mut c_626:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_627:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1261 = c_627;
            ...
            put_bits -= 8i32;
             let mut c_628:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1263 = c_628;
            ...
            put_bits -= 8i32;
             let mut c_629:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1265 = c_629;
            ...
            put_bits -= 8i32;
             let mut c_630:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
    ...
    1u64;
        ...
        while r > 15i32 {
            if put_bits > 47i32 {
                ...
                put_bits -= 8i32;
                 let mut c_631:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1269 = c_631;
                ...
                put_bits -= 8i32;
                 let mut c_632:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1271 = c_632;
                ...
                put_bits -= 8i32;
                 let mut c_633:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1273 = c_633;
                ...
                put_bits -= 8i32;
                 let mut c_634:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1275 = c_634;
                ...
                put_bits -= 8i32;
                 let mut c_635:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
                ...
                *fresh1277 = c_635;
                ...
                put_bits -= 8i32;
                 let mut c_636:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
        ...
        if put_bits > 31i32 {
            ...
            put_bits -= 8i32;
             let mut c_637:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1281 = c_637;
            ...
            put_bits -= 8i32;
             let mut c_638:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1283 = c_638;
            ...
            put_bits -= 8i32;
             let mut c_639:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1285 = c_639;
            ...
            put_bits -= 8i32;
             let mut c_640:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
    ...
    if r > 0i32 {
        ...
        if put_bits > 47i32 {
            ...
            put_bits -= 8i32;
             let mut c_641:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1289 = c_641;
            ...
            put_bits -= 8i32;
             let mut c_642:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1291 = c_642;
            ...
            put_bits -= 8i32;
             let mut c_643:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1293 = c_643;
            ...
            put_bits -= 8i32;
             let mut c_644:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1295 = c_644;
            ...
            put_bits -= 8i32;
             let mut c_645:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
            ...
            *fresh1297 = c_645;
            ...
            put_bits -= 8i32;
             let mut c_646:   crate::jmorecfg_h::JOCTET =
     (put_buffer >> put_bits) as crate::jmorecfg_h::JOCTET;
...
unsafe extern "C" fn htest_one_block(
    ...
    mut ac_counts: *mut libc::c_long,
     ...
     let mut temp:   libc::c_int =  *block.offset(0) as libc::c_int - last_dc_val;
    if temp < 0i32 {
        temp = -temp
    }
     let mut nbits:   libc::c_int =  0i32;
    while temp != 0 {
        nbits += 1;
        temp >>= 1i32
    }
    ...
    *fresh1303 += 1;
     ...
     let mut r:   libc::c_int =  0i32; let mut k:   libc::c_int =  1i32;
...
pub unsafe extern "C" fn jpeg_gen_optimal_table(
    ...
    mut freq: *mut libc::c_long,
     ...
     let mut bits:  [crate::jmorecfg_h::UINT8; 33] =  [0; 33]; let mut codesize:  [libc::c_int; 257] =  [0; 257]; let mut others:  [libc::c_int; 257] =  [0; 257];   let mut j:  libc::c_int =  0;
    ...
    *freq.offset(256) = 1i64;
    ...
    /* In case of ties, take the larger symbol number */
    {
         ...
         let mut c1:   libc::c_int =  -1i32; let mut v:   libc::c_long =  1000000000i64;
        i = 0i32;
        while i <= 256i32 {
...
unsafe extern "C" fn finish_pass_gather(mut cinfo: crate::jpeglib_h::j_compress_ptr) {
      let mut did_dc:  [crate::jmorecfg_h::boolean; 4] =  [0; 4]; let mut did_ac:  [crate::jmorecfg_h::boolean; 4] =  [0; 4];let mut entropy: huff_entropy_ptr = (*cinfo).entropy as huff_entropy_ptr;
