...
pub use crate::jmorecfg_h::{
    boolean, rgb_pixelsize, CENTERJSAMPLE, EXT_BGRX_PIXELSIZE, EXT_BGR_PIXELSIZE,
    EXT_RGBX_PIXELSIZE, EXT_RGB_PIXELSIZE, EXT_XBGR_PIXELSIZE, EXT_XRGB_PIXELSIZE, FALSE, JCOEF,
    JDIMENSION, JOCTET, JSAMPLE, MAXJSAMPLE, RGB_PIXELSIZE, TRUE, UINT16, UINT8,
};
pub use crate::jpegint_h::{
    ...
    jinit_phuff_decoder, jinit_upsampler, jpeg_color_deconverter, jpeg_color_quantizer,
    ...
    jpeg_upsampler, DSTATE_BUFIMAGE, DSTATE_READY, JBUF_CRANK_DEST, JBUF_PASS_THRU, JBUF_REQUANT,
