...
use crate::stdlib::{ferror, fflush, fwrite, memset, putc};use libc::{c_uint, c_ulong, c_char, c_void, c_int, self};pub use crate::cderror_h::{C2RustUnnamed_4, JERR_BAD_CMAP_FILE,
                        ...
                        __off64_t, __off_t, FILE, _IO_FILE};pub use crate::jmorecfg_h::{boolean, JCOEF, JDIMENSION, JOCTET, JSAMPLE,
                            UINT16, UINT8};pub use crate::stddef_h::size_t;pub use crate::jpeglib_h::{j_common_ptr, j_decompress_ptr,
