...
use crate::stdlib::malloc;use libc::{c_uint, c_ulong, c_int, c_char, self};pub use crate::jmorecfg_h::{boolean, FALSE, JCOEF, JDIMENSION, JOCTET,
                            JSAMPLE, TRUE, UINT16, UINT8};pub use crate::jpegint_h::{inverse_DCT_method_ptr, DSTATE_READY,
                           ...
                           JDITHER_ORDERED, JHUFF_TBL, JPEG_APP0, JQUANT_TBL,
