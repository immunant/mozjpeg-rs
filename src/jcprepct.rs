...
use crate::stdlib::memcpy;use libc::{c_uint, c_ulong, c_void, c_long, c_int, self};pub use crate::jmorecfg_h::{boolean, JCOEF, JDIMENSION, JOCTET, JSAMPLE,
                            UINT16, UINT8};pub use crate::stddef_h::size_t;pub use crate::jpegint_h::{jcopy_sample_rows, JBUF_CRANK_DEST, JBUF_PASS_THRU,
                           JBUF_REQUANT, JBUF_SAVE_AND_PASS, JBUF_SAVE_SOURCE,
                           J_BUF_MODE};pub use crate::jpeglib_h::{j_common_ptr, j_compress_ptr,
