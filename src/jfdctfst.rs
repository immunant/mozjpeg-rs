...
use libc::{c_int, c_long, self};pub use crate::jpegint_h::JLONG;pub use crate::jdct_h::DCTELEM;pub use crate::jpeglib_h::DCTSIZE;
/*
 * jfdctfst.c
 *
...
pub unsafe extern "C" fn jpeg_fdct_ifast(mut data: *mut DCTELEM) {
     ...
     let mut tmp0:  DCTELEM =  0; let mut tmp1:  DCTELEM =  0; let mut tmp2:  DCTELEM =  0; let mut tmp3:  DCTELEM =  0; let mut tmp4:  DCTELEM =  0; let mut tmp5:  DCTELEM =  0; let mut tmp6:  DCTELEM =  0; let mut tmp7:  DCTELEM =  0; let mut tmp10:  DCTELEM =  0; let mut tmp11:  DCTELEM =  0; let mut tmp12:  DCTELEM =  0; let mut tmp13:  DCTELEM =  0; let mut z1:  DCTELEM =  0; let mut z2:  DCTELEM =  0; let mut z3:  DCTELEM =  0; let mut z4:  DCTELEM =  0; let mut z5:  DCTELEM =  0; let mut z11:  DCTELEM =  0; let mut z13:  DCTELEM =  0;  
    
     let mut dataptr:   *mut DCTELEM =  data; let mut ctr:   c_int =  DCTSIZE - 1i32;
    while ctr >= 0i32 {
        tmp0 = (*dataptr.offset(0) as c_int + *dataptr.offset(7) as c_int)
            as DCTELEM;
        tmp7 = (*dataptr.offset(0) as c_int - *dataptr.offset(7) as c_int)
            as DCTELEM;
        tmp1 = (*dataptr.offset(1) as c_int + *dataptr.offset(6) as c_int)
            as DCTELEM;
        tmp6 = (*dataptr.offset(1) as c_int - *dataptr.offset(6) as c_int)
            as DCTELEM;
        tmp2 = (*dataptr.offset(2) as c_int + *dataptr.offset(5) as c_int)
            as DCTELEM;
        tmp5 = (*dataptr.offset(2) as c_int - *dataptr.offset(5) as c_int)
            as DCTELEM;
        tmp3 = (*dataptr.offset(3) as c_int + *dataptr.offset(4) as c_int)
            as DCTELEM;
        tmp4 = (*dataptr.offset(3) as c_int - *dataptr.offset(4) as c_int)
            as DCTELEM;
        ...
        *dataptr.offset(0) =
            (tmp10 as c_int + tmp11 as c_int) as DCTELEM;
        *dataptr.offset(4) =
            (tmp10 as c_int - tmp11 as c_int) as DCTELEM;
        z1 = ((tmp12 as c_int + tmp13 as c_int) as c_long
            * 181i64
            >> 8i32) as DCTELEM;
        ...
        *dataptr.offset(6) = (tmp13 as c_int - z1 as c_int) as DCTELEM;
        ...
        z5 = ((tmp10 as c_int - tmp12 as c_int) as c_long
            * 98i64
            >> 8i32) as DCTELEM;
        z2 = ((tmp10 as c_long * 139i64 >> 8i32)
            as DCTELEM as c_int
            + z5 as c_int) as DCTELEM;
        z4 = ((tmp12 as c_long * 334i64 >> 8i32)
            as DCTELEM as c_int
            + z5 as c_int) as DCTELEM;
        z3 = (tmp11 as c_long * 181i64 >> 8i32)
            as DCTELEM;
    ...
    while ctr >= 0i32 {
        ...
        *dataptr.offset((DCTSIZE * 2i32) as isize) =
            (tmp13 as c_int + z1 as c_int) as DCTELEM;
