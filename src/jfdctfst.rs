...
pub unsafe extern "C" fn jpeg_fdct_ifast(mut data: *mut DCTELEM) {
    ...
    while ctr >= 0i32 {
        ...
        *dataptr.offset(4) = (tmp10 as c_int - tmp11 as c_int) as DCTELEM;
        z1 = ((tmp12 as c_int + tmp13 as c_int) as c_long * 181i64 >> 8i32) as DCTELEM;
        ...
        *dataptr.offset(6) = (tmp13 as c_int - z1 as c_int) as DCTELEM;
        ...
        z5 = ((tmp10 as c_int - tmp12 as c_int) as c_long * 98i64 >> 8i32) as DCTELEM;
        z2 = ((tmp10 as c_long * 139i64 >> 8i32) as DCTELEM as c_int + z5 as c_int) as DCTELEM;
        z4 = ((tmp12 as c_long * 334i64 >> 8i32) as DCTELEM as c_int + z5 as c_int) as DCTELEM;
        z3 = (tmp11 as c_long * 181i64 >> 8i32) as DCTELEM;
