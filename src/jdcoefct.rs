...
pub use crate::jpegint_h::{
    inverse_DCT_method_ptr, jcopy_block_row, jpeg_color_deconverter, jpeg_color_quantizer,
    ...
    jpeg_upsampler, jround_up, jzero_far, JBUF_CRANK_DEST, JBUF_PASS_THRU, JBUF_REQUANT,
...
pub use crate::jpeglib_h::{
    ...
    C2RustUnnamed_2, JCS_YCbCr, DCTSIZE2, D_MAX_BLOCKS_IN_MCU, JBLOCK, JBLOCKARRAY, JBLOCKROW,
    ...
    JDITHER_NONE, JDITHER_ORDERED, JHUFF_TBL, JPEG_ROW_COMPLETED, JPEG_SCAN_COMPLETED,
    JPEG_SUSPENDED, JPOOL_IMAGE, JQUANT_TBL, JSAMPARRAY, JSAMPIMAGE, JSAMPROW, J_COLOR_SPACE,
