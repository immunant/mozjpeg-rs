...
pub unsafe extern "C" fn jpeg_write_scanlines(
    ...
    let mut rows_left: JDIMENSION = (*cinfo).image_height - (*cinfo).next_scanline;
...
pub unsafe extern "C" fn jpeg_write_raw_data(
    ...
    let mut lines_per_iMCU_row: JDIMENSION = ((*cinfo).max_v_samp_factor * DCTSIZE) as JDIMENSION;
    ...
    (*cinfo).next_scanline = (*cinfo).next_scanline + lines_per_iMCU_row;
