...
use crate::stdlib::{ferror, fflush, free, fwrite, malloc, memcpy};use libc::{c_uchar, c_ulong, c_int, c_void, self};pub use crate::jpegint_h::{JBUF_CRANK_DEST, JBUF_PASS_THRU, JBUF_REQUANT,
...
unsafe extern "C" fn term_destination(mut cinfo: j_compress_ptr) {
    ...
    let mut datacount: size_t =
        OUTPUT_BUF_SIZE as c_ulong - (*dest).pub_0.free_in_buffer;
