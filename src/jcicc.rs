...
use libc::{c_int, c_uint, self};pub use crate::jmorecfg_h::{boolean, JCOEF, JDIMENSION, JOCTET, JSAMPLE,
                            UINT16, UINT8};pub use crate::jpegint_h::{CSTATE_SCANNING, JBUF_CRANK_DEST, JBUF_PASS_THRU,
                           JBUF_REQUANT, JBUF_SAVE_AND_PASS, JBUF_SAVE_SOURCE,
                           J_BUF_MODE};pub use crate::stddef_h::{size_t, NULL};pub use crate::jpeglib_h::{j_common_ptr, j_compress_ptr,
                           ...
                           jpeg_write_m_byte, jpeg_write_m_header,
                           ...
                           JDCT_IFAST, JDCT_ISLOW, JHUFF_TBL, JPEG_APP0,
                           JQUANT_TBL, JSAMPARRAY, JSAMPIMAGE, JSAMPROW,
                           J_COLOR_SPACE, J_DCT_METHOD};pub use super::jerror::{C2RustUnnamed_3, JERR_ARITH_NOTIMPL,
...
pub unsafe extern "C" fn jpeg_write_icc_profile(
    ...
    if (*cinfo).global_state < CSTATE_SCANNING {
     ...
     let mut num_markers:   c_uint =
      icc_data_len / MAX_DATA_BYTES_IN_MARKER as c_uint;
    if  num_markers * MAX_DATA_BYTES_IN_MARKER as c_uint != icc_data_len {
        num_markers +=  1
    }
    while icc_data_len > 0u32 {
        /* length of profile to put in this marker */
         let mut cur_marker:  c_int =  1i32;  let mut length:   c_uint =  icc_data_len;
        ...
        jpeg_write_m_header(
            ...
            length + ICC_OVERHEAD_LEN as c_uint,
        );
