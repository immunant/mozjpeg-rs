use libc::c_uint;use libc::c_ulong;use libc::c_float;use libc::c_double;use libc::c_void;use libc::intptr_t;use libc::c_int;use libc;
...
use super::simd::x86_64::jsimd::jsimd_can_convsamp;
use super::simd::x86_64::jsimd::jsimd_can_convsamp_float;
use super::simd::x86_64::jsimd::jsimd_can_fdct_float;
use super::simd::x86_64::jsimd::jsimd_can_fdct_ifast;
use super::simd::x86_64::jsimd::jsimd_can_fdct_islow;
use super::simd::x86_64::jsimd::jsimd_can_quantize;
use super::simd::x86_64::jsimd::jsimd_can_quantize_float;
use super::simd::x86_64::jsimd::jsimd_convsamp;
use super::simd::x86_64::jsimd::jsimd_convsamp_float;
use super::simd::x86_64::jsimd::jsimd_fdct_float;
use super::simd::x86_64::jsimd::jsimd_fdct_ifast;
use super::simd::x86_64::jsimd::jsimd_fdct_islow;
use super::simd::x86_64::jsimd::jsimd_quantize;
use super::simd::x86_64::jsimd::jsimd_quantize_float;
...
unsafe extern "C" fn compute_reciprocal(
    ...
    if divisor as c_int == 1i32 {
         ...
         */
        *dtbl.offset((DCTSIZE2 * 0i32) as isize) = 1i16; /* reciprocal */
