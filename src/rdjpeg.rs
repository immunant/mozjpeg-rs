...
pub use crate::src::jdatasrc::jpeg_stdio_src;
...
unsafe extern "C" fn get_rows(
    ...
    return crate::src::jdapistd::jpeg_read_scanlines(
        &mut (*source).dinfo,
        (*source).pub_0.buffer,
...
unsafe extern "C" fn start_input_jpeg(
    ...
    let mut source: jpeg_source_ptr = sinfo as jpeg_source_ptr;
    (*source).dinfo.err = crate::src::jerror::jpeg_std_error(&mut (*source).jerr);
    ...
    crate::src::jdatasrc::jpeg_stdio_src(&mut (*source).dinfo, (*source).pub_0.input_file);
    ...
    crate::src::jdapimin::jpeg_read_header(&mut (*source).dinfo, crate::jmorecfg_h::TRUE);
    (*source).pub_0.marker_list = (*source).dinfo.marker_list;
    (*source).dinfo.raw_data_out = crate::jmorecfg_h::FALSE;
    crate::src::jdapistd::jpeg_start_decompress(&mut (*source).dinfo);
...
unsafe extern "C" fn finish_input_jpeg(
    ...
    let mut source: jpeg_source_ptr = sinfo as jpeg_source_ptr;
    crate::src::jdapimin::jpeg_finish_decompress(&mut (*source).dinfo);
    crate::src::jdapimin::jpeg_destroy_decompress(&mut (*source).dinfo);
}
/*
 * cdjpeg.h
 *
