...
unsafe extern "C" fn start_pass_huff_decoder(mut cinfo: j_decompress_ptr) {
    ...
    while ci < (*cinfo).comps_in_scan {
        ...
        let mut pdtbl: *mut *mut d_derived_tbl = (*entropy)
            .dc_derived_tbls
            .as_mut_ptr()
...
pub unsafe extern "C" fn jpeg_make_d_derived_tbl(
    ...
    while l <= HUFF_LOOKAHEAD {
        ...
        while i <= (*htbl).bits[l as usize] as c_int {
            ...
            let mut lookbits: c_int = (huffcode[p as usize] << HUFF_LOOKAHEAD - l) as c_int;
            let mut ctr: c_int = 1i32 << HUFF_LOOKAHEAD - l;
            while ctr > 0i32 {
...
pub unsafe extern "C" fn jpeg_huff_decode(
    ...
    bits_left -= l;
    let mut code: JLONG = ((get_buffer >> bits_left) as c_int & (1i32 << l) - 1i32) as JLONG;
...
unsafe extern "C" fn process_restart(mut cinfo: j_decompress_ptr) -> boolean {
    ...
    (*(*cinfo).marker).discarded_bytes =
        (*(*cinfo).marker).discarded_bytes + ((*entropy).bitstate.bits_left / 8i32) as c_uint;
...
unsafe extern "C" fn decode_mcu_slow(
    ...
    let mut br_state: bitread_working_state = bitread_working_state {
        next_input_byte: ::std::ptr::null::<JOCTET>(),
        bytes_in_buffer: 0,
        get_buffer: 0,
        bits_left: 0,
        cinfo: ::std::ptr::null_mut::<jpeg_decompress_struct>(),
    };
    let mut entropy: huff_entropy_ptr = (*cinfo).entropy as huff_entropy_ptr;
    ...
    let mut get_buffer: bit_buf_type = (*entropy).bitstate.get_buffer;
    let mut bits_left: c_int = (*entropy).bitstate.bits_left;
    let mut state: savable_state = (*entropy).saved;
    let mut blkn: c_int = 0i32;
    while blkn < (*cinfo).blocks_in_MCU {
        let mut s: c_int = 0;
        let mut k: c_int = 0;
        ...
        if s != 0 {
            ...
            s = (r as c_uint
                + ((r - (1i32 << s - 1i32) >> 31i32) as c_uint & ((-1i32 as c_uint) << s) + 1u32))
                as c_int
        }
...
unsafe extern "C" fn decode_mcu_fast(
    ...
    let mut get_buffer: bit_buf_type = (*entropy).bitstate.get_buffer;
    let mut bits_left: c_int = (*entropy).bitstate.bits_left;
    let mut buffer: *mut JOCTET = br_state.next_input_byte as *mut JOCTET;
    let mut state: savable_state = (*entropy).saved;
    let mut blkn: c_int = 0i32;
    while blkn < (*cinfo).blocks_in_MCU {
        let mut k: c_int = 0;
        ...
        if bits_left <= 16i32 {
            ...
            let mut c0: c_int = *fresh5 as c_int;
            let mut c1: c_int = *buffer as c_int;
            ...
            let mut c0_0: c_int = *fresh6 as c_int;
            let mut c1_0: c_int = *buffer as c_int;
            ...
            let mut c0_1: c_int = *fresh7 as c_int;
            let mut c1_1: c_int = *buffer as c_int;
            ...
            let mut c0_2: c_int = *fresh8 as c_int;
            let mut c1_2: c_int = *buffer as c_int;
            ...
            let mut c0_3: c_int = *fresh9 as c_int;
            let mut c1_3: c_int = *buffer as c_int;
            ...
            let mut c0_4: c_int = *fresh10 as c_int;
            let mut c1_4: c_int = *buffer as c_int;
        ...
        let mut s: c_int = (get_buffer >> bits_left - 8i32) as c_int & (1i32 << 8i32) - 1i32;
        ...
        if s != 0 {
            if bits_left <= 16i32 {
                ...
                let mut c0_5: c_int = *fresh11 as c_int;
                let mut c1_5: c_int = *buffer as c_int;
                ...
                let mut c0_6: c_int = *fresh12 as c_int;
                let mut c1_6: c_int = *buffer as c_int;
                ...
                let mut c0_7: c_int = *fresh13 as c_int;
                let mut c1_7: c_int = *buffer as c_int;
                ...
                let mut c0_8: c_int = *fresh14 as c_int;
                let mut c1_8: c_int = *buffer as c_int;
                ...
                let mut c0_9: c_int = *fresh15 as c_int;
                let mut c1_9: c_int = *buffer as c_int;
                ...
                let mut c0_10: c_int = *fresh16 as c_int;
                let mut c1_10: c_int = *buffer as c_int;
        ...
        if (*entropy).ac_needed[blkn as usize] != 0 && !block.is_null() {
            ...
            while k < DCTSIZE2 {
                if bits_left <= 16i32 {
                    ...
                    let mut c0_11: c_int = *fresh17 as c_int;
                    let mut c1_11: c_int = *buffer as c_int;
                    ...
                    let mut c0_12: c_int = *fresh18 as c_int;
                    let mut c1_12: c_int = *buffer as c_int;
                    ...
                    let mut c0_13: c_int = *fresh19 as c_int;
                    let mut c1_13: c_int = *buffer as c_int;
                    ...
                    let mut c0_14: c_int = *fresh20 as c_int;
                    let mut c1_14: c_int = *buffer as c_int;
                    ...
                    let mut c0_15: c_int = *fresh21 as c_int;
                    let mut c1_15: c_int = *buffer as c_int;
                    ...
                    let mut c0_16: c_int = *fresh22 as c_int;
                    let mut c1_16: c_int = *buffer as c_int;
                ...
                if s != 0 {
                    ...
                    if bits_left <= 16i32 {
                        ...
                        let mut c0_17: c_int = *fresh23 as c_int;
                        let mut c1_17: c_int = *buffer as c_int;
                        ...
                        let mut c0_18: c_int = *fresh24 as c_int;
                        let mut c1_18: c_int = *buffer as c_int;
                        ...
                        let mut c0_19: c_int = *fresh25 as c_int;
                        let mut c1_19: c_int = *buffer as c_int;
                        ...
                        let mut c0_20: c_int = *fresh26 as c_int;
                        let mut c1_20: c_int = *buffer as c_int;
                        ...
                        let mut c0_21: c_int = *fresh27 as c_int;
                        let mut c1_21: c_int = *buffer as c_int;
                        ...
                        let mut c0_22: c_int = *fresh28 as c_int;
                        let mut c1_22: c_int = *buffer as c_int;
            ...
            while k < DCTSIZE2 {
                if bits_left <= 16i32 {
                    ...
                    let mut c0_23: c_int = *fresh29 as c_int;
                    let mut c1_23: c_int = *buffer as c_int;
                    ...
                    let mut c0_24: c_int = *fresh30 as c_int;
                    let mut c1_24: c_int = *buffer as c_int;
                    ...
                    let mut c0_25: c_int = *fresh31 as c_int;
                    let mut c1_25: c_int = *buffer as c_int;
                    ...
                    let mut c0_26: c_int = *fresh32 as c_int;
                    let mut c1_26: c_int = *buffer as c_int;
                    ...
                    let mut c0_27: c_int = *fresh33 as c_int;
                    let mut c1_27: c_int = *buffer as c_int;
                    ...
                    let mut c0_28: c_int = *fresh34 as c_int;
                    let mut c1_28: c_int = *buffer as c_int;
                ...
                if s != 0 {
                    ...
                    if bits_left <= 16i32 {
                        ...
                        let mut c0_29: c_int = *fresh35 as c_int;
                        let mut c1_29: c_int = *buffer as c_int;
                        ...
                        let mut c0_30: c_int = *fresh36 as c_int;
                        let mut c1_30: c_int = *buffer as c_int;
                        ...
                        let mut c0_31: c_int = *fresh37 as c_int;
                        let mut c1_31: c_int = *buffer as c_int;
                        ...
                        let mut c0_32: c_int = *fresh38 as c_int;
                        let mut c1_32: c_int = *buffer as c_int;
                        ...
                        let mut c0_33: c_int = *fresh39 as c_int;
                        let mut c1_33: c_int = *buffer as c_int;
                        ...
                        let mut c0_34: c_int = *fresh40 as c_int;
                        let mut c1_34: c_int = *buffer as c_int;
    ...
    br_state.bytes_in_buffer =
        br_state.bytes_in_buffer - buffer.wrapping_offset_from(br_state.next_input_byte) as c_ulong;
...
unsafe extern "C" fn decode_mcu(
    ...
    if (*(*cinfo).src).bytes_in_buffer < BUFSIZE as c_ulong * (*cinfo).blocks_in_MCU as size_t
        || (*cinfo).unread_marker != 0i32
    {
        usefast = 0i32
    }
