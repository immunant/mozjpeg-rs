...
pub unsafe extern "C" fn jpeg_idct_float(
    ...
    mut output_col: crate::jmorecfg_h::JDIMENSION,
     ...
     let mut tmp0:  libc::c_float =  0.; let mut tmp1:  libc::c_float =  0.; let mut tmp2:  libc::c_float =  0.; let mut tmp3:  libc::c_float =  0.; let mut tmp4:  libc::c_float =  0.; let mut tmp5:  libc::c_float =  0.; let mut tmp6:  libc::c_float =  0.; let mut tmp7:  libc::c_float =  0.; let mut tmp10:  libc::c_float =  0.; let mut tmp11:  libc::c_float =  0.; let mut tmp12:  libc::c_float =  0.; let mut tmp13:  libc::c_float =  0.; let mut z5:  libc::c_float =  0.; let mut z10:  libc::c_float =  0.; let mut z11:  libc::c_float =  0.; let mut z12:  libc::c_float =  0.; let mut z13:  libc::c_float =  0.;     let mut workspace:  [libc::c_float; 64] =  [0.; 64];
    let mut range_limit: *mut crate::jmorecfg_h::JSAMPLE = (*cinfo).sample_range_limit;
     ...
     let mut inptr:   crate::jpeglib_h::JCOEFPTR =  coef_block; let mut quantptr:   *mut crate::jdct_h::FLOAT_MULT_TYPE =
     (*compptr).dct_table as *mut crate::jdct_h::FLOAT_MULT_TYPE; let mut wsptr:   *mut libc::c_float =  workspace.as_mut_ptr(); let mut ctr:   libc::c_int =  crate::jpeglib_h::DCTSIZE;
    while ctr > 0i32 {
